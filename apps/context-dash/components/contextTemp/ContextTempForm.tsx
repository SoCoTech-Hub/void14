...
import { ContextTemp, NewContextTempParams, insertContextTempParams } from "@/lib/db/schema/contextTemp";
                  ...
                  <SelectContent>
                    {contexts?.contexts.map((context) => (
                      <SelectItem key={context.id} value={context.id.toString()}>
                        {context.id}  {/* TODO: Replace with a field from the context model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
