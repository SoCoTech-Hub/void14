...
export const portfolioInstances = pgTable('portfolio_instances', {
...
export const insertPortfolioInstanceSchema = createInsertSchema(portfolioInstances);
export const insertPortfolioInstanceParams = baseSchema.extend({
...
export type NewPortfolioInstance = z.infer<typeof insertPortfolioInstanceSchema>;
export type NewPortfolioInstanceParams = z.infer<typeof insertPortfolioInstanceParams>;
export type UpdatePortfolioInstanceParams = z.infer<typeof updatePortfolioInstanceParams>;
export type PortfolioInstanceId = z.infer<typeof portfolioInstanceIdSchema>["id"];
    
// this type infers the return from getPortfolioInstances() - meaning it will include any joins
export type CompletePortfolioInstance = Awaited<ReturnType<typeof getPortfolioInstances>>["portfolioInstances"][number];
