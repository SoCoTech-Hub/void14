...
import { PortfolioInstanceConfig } from "@/lib/db/schema/portfolioInstanceConfigs";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Portfolio Instance Config</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <PortfolioInstanceConfigForm closeModal={closeModal} portfolioInstanceConfig={portfolioInstanceConfig} />
        </div>
      </DialogContent>
    </Dialog>
  );
