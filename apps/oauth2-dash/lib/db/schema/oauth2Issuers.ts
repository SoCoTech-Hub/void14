...
export const oauth2Issuers = pgTable('oauth2_issuers', {
...
export const insertOauth2IssuerSchema = createInsertSchema(oauth2Issuers).omit(timestamps);
export const insertOauth2IssuerParams = baseSchema.extend({
...
export const updateOauth2IssuerParams = baseSchema.extend({
  basicAuth: z.coerce.boolean(),
  enabled: z.coerce.boolean(),
  requireConfirmation: z.coerce.boolean(),
  showOnLoginPage: z.coerce.boolean(),
...
export type CompleteOauth2Issuer = Awaited<ReturnType<typeof getOauth2Issuers>>["oauth2Issuers"][number];
