...
import { CourseFormatOption, NewCourseFormatOptionParams, insertCourseFormatOptionParams } from "@/lib/db/schema/courseFormatOptions";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCourseFormatOption({ id: courseFormatOption.id })}
          >
