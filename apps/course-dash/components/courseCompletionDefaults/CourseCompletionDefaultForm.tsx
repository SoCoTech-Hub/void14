...
import { CourseCompletionDefault, NewCourseCompletionDefaultParams, insertCourseCompletionDefaultParams } from "@/lib/db/schema/courseCompletionDefaults";
...
const CourseCompletionDefaultForm = ({
  ...
  const handleSubmit = (values: NewCourseCompletionDefaultParams) => {
    if (editing) {
      updateCourseCompletionDefault({ ...values, id: courseCompletionDefault.id });
    } else {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCourseCompletionDefault({ id: courseCompletionDefault.id })}
          >
