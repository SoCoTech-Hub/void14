...
const CourseForm = ({
  ...
  const { data: courseCategories } = trpc.courseCategories.getCourseCategories.useQuery();
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        <FormField
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Course Category Id</FormLabel>
                <FormControl>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    {courseCategories?.courseCategories.map((courseCategory) => (
                      <SelectItem key={courseCategory.id} value={courseCategory.id.toString()}>
                        {courseCategory.id}  {/* TODO: Replace with a field from the courseCategory model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
