...
import { CourseCompletionCriteria, NewCourseCompletionCriteriaParams, insertCourseCompletionCriteriaParams } from "@/lib/db/schema/courseCompletionCriterias";
...
const CourseCompletionCriteriaForm = ({
  ...
  const handleSubmit = (values: NewCourseCompletionCriteriaParams) => {
    if (editing) {
      updateCourseCompletionCriteria({ ...values, id: courseCompletionCriteria.id });
    } else {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCourseCompletionCriteria({ id: courseCompletionCriteria.id })}
          >
