...
export const courseFormatOptions = pgTable('course_format_options', {
  ...
  return {
    courseIdIndex: uniqueIndex('course_id_idx').on(courseFormatOptions.courseId),
  }
});
...
export const insertCourseFormatOptionSchema = createInsertSchema(courseFormatOptions);
export const insertCourseFormatOptionParams = baseSchema.extend({
...
export type NewCourseFormatOption = z.infer<typeof insertCourseFormatOptionSchema>;
export type NewCourseFormatOptionParams = z.infer<typeof insertCourseFormatOptionParams>;
export type UpdateCourseFormatOptionParams = z.infer<typeof updateCourseFormatOptionParams>;
export type CourseFormatOptionId = z.infer<typeof courseFormatOptionIdSchema>["id"];
    
// this type infers the return from getCourseFormatOptions() - meaning it will include any joins
export type CompleteCourseFormatOption = Awaited<ReturnType<typeof getCourseFormatOptions>>["courseFormatOptions"][number];
