import { varchar, integer, timestamp, real, pgTable } from "drizzle-orm/pg-core";
...
export const courseCompletionCriterias = pgTable('course_completion_criterias', {
  ...
  return {
    courseIdIndex: uniqueIndex('course_id_idx').on(courseCompletionCriterias.courseId),
  }
});
...
export const insertCourseCompletionCriteriaSchema = createInsertSchema(courseCompletionCriterias);
export const insertCourseCompletionCriteriaParams = baseSchema.extend({
...
export type CourseCompletionCriteria = typeof courseCompletionCriterias.$inferSelect;
export type NewCourseCompletionCriteria = z.infer<typeof insertCourseCompletionCriteriaSchema>;
export type NewCourseCompletionCriteriaParams = z.infer<typeof insertCourseCompletionCriteriaParams>;
export type UpdateCourseCompletionCriteriaParams = z.infer<typeof updateCourseCompletionCriteriaParams>;
export type CourseCompletionCriteriaId = z.infer<typeof courseCompletionCriteriaIdSchema>["id"];
    
// this type infers the return from getCourseCompletionCriterias() - meaning it will include any joins
export type CompleteCourseCompletionCriteria = Awaited<ReturnType<typeof getCourseCompletionCriterias>>["courseCompletionCriterias"][number];
