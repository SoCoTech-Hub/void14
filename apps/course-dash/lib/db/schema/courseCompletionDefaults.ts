...
export const courseCompletionDefaults = pgTable('course_completion_defaults', {
  ...
  return {
    courseIdIndex: uniqueIndex('course_id_idx').on(courseCompletionDefaults.courseId),
  }
});
...
export const insertCourseCompletionDefaultSchema = createInsertSchema(courseCompletionDefaults);
export const insertCourseCompletionDefaultParams = baseSchema.extend({
...
export type CourseCompletionDefault = typeof courseCompletionDefaults.$inferSelect;
export type NewCourseCompletionDefault = z.infer<typeof insertCourseCompletionDefaultSchema>;
export type NewCourseCompletionDefaultParams = z.infer<typeof insertCourseCompletionDefaultParams>;
export type UpdateCourseCompletionDefaultParams = z.infer<typeof updateCourseCompletionDefaultParams>;
export type CourseCompletionDefaultId = z.infer<typeof courseCompletionDefaultIdSchema>["id"];
    
// this type infers the return from getCourseCompletionDefaults() - meaning it will include any joins
export type CompleteCourseCompletionDefault = Awaited<ReturnType<typeof getCourseCompletionDefaults>>["courseCompletionDefaults"][number];
