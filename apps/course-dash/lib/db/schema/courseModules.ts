import { varchar, timestamp, boolean, integer, text, pgTable } from "drizzle-orm/pg-core";
...
export const courseModules = pgTable('course_modules', {
  ...
  completionGradeItemNumber: varchar("completion_grade_item_number", { length: 256 }),
...
export const insertCourseModuleParams = baseSchema.extend({
...
export type CompleteCourseModule = Awaited<ReturnType<typeof getCourseModules>>["courseModules"][number];
