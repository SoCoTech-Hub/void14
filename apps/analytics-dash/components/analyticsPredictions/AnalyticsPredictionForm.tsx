...
import { AnalyticsPrediction, NewAnalyticsPredictionParams, insertAnalyticsPredictionParams } from "@/lib/db/schema/analyticsPredictions";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        <FormField
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Prediction Score</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAnalyticsPrediction({ id: analyticsPrediction.id })}
          >
