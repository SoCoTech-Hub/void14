...
import { AnalyticsTrainSample, NewAnalyticsTrainSampleParams, insertAnalyticsTrainSampleParams } from "@/lib/db/schema/analyticsTrainSamples";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAnalyticsTrainSample({ id: analyticsTrainSample.id })}
          >
