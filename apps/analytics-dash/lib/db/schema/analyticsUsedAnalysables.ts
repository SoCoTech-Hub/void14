...
const baseSchema = createSelectSchema(analyticsUsedAnalysables).omit(timestamps)
...
export type CompleteAnalyticsUsedAnalysable = Awaited<
	ReturnType<typeof getAnalyticsUsedAnalysables>
>['analyticsUsedAnalysables'][number]
