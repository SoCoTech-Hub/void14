...
export const analyticsPredictSamples = pgTable('analytics_predict_samples', {
  ...
  return {
    modelIdIndex: uniqueIndex('model_id_idx').on(analyticsPredictSamples.modelId),
  }
});
...
export const insertAnalyticsPredictSampleSchema = createInsertSchema(analyticsPredictSamples).omit(timestamps);
...
export type NewAnalyticsPredictSample = z.infer<typeof insertAnalyticsPredictSampleSchema>;
export type NewAnalyticsPredictSampleParams = z.infer<typeof insertAnalyticsPredictSampleParams>;
export type UpdateAnalyticsPredictSampleParams = z.infer<typeof updateAnalyticsPredictSampleParams>;
export type AnalyticsPredictSampleId = z.infer<typeof analyticsPredictSampleIdSchema>["id"];
    
// this type infers the return from getAnalyticsPredictSamples() - meaning it will include any joins
export type CompleteAnalyticsPredictSample = Awaited<ReturnType<typeof getAnalyticsPredictSamples>>["analyticsPredictSamples"][number];
