...
import { type getAnalyticsModelLogs } from '@/lib/api/analyticsModelLogs/queries'
...
export type NewAnalyticsModelLog = z.infer<typeof insertAnalyticsModelLogSchema>
