...
export const analyticsTrainSamples = pgTable('analytics_train_samples', {
  ...
  return {
    modelIdIndex: uniqueIndex('model_id_idx').on(analyticsTrainSamples.modelId),
  }
});
...
export const insertAnalyticsTrainSampleSchema = createInsertSchema(analyticsTrainSamples).omit(timestamps);
...
export type NewAnalyticsTrainSample = z.infer<typeof insertAnalyticsTrainSampleSchema>;
export type NewAnalyticsTrainSampleParams = z.infer<typeof insertAnalyticsTrainSampleParams>;
export type UpdateAnalyticsTrainSampleParams = z.infer<typeof updateAnalyticsTrainSampleParams>;
export type AnalyticsTrainSampleId = z.infer<typeof analyticsTrainSampleIdSchema>["id"];
    
// this type infers the return from getAnalyticsTrainSamples() - meaning it will include any joins
export type CompleteAnalyticsTrainSample = Awaited<ReturnType<typeof getAnalyticsTrainSamples>>["analyticsTrainSamples"][number];
