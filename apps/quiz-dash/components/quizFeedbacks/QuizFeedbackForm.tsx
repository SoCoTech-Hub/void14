...
import { QuizFeedback, NewQuizFeedbackParams, insertQuizFeedbackParams } from "@/lib/db/schema/quizFeedbacks";
                ...
                >
                  ...
                  <SelectContent>
                    {quizes?.quizes.map((quize) => (
                      <SelectItem key={quize.id} value={quize.id.toString()}>
                        {quize.id}  {/* TODO: Replace with a field from the quize model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
