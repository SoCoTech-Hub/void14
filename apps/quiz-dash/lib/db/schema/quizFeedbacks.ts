...
export const quizFeedbacks = pgTable('quiz_feedbacks', {
  ...
  return {
    quizeIdIndex: uniqueIndex('quize_id_idx').on(quizFeedbacks.quizeId),
  }
});
...
export const insertQuizFeedbackParams = baseSchema.extend({
...
export type CompleteQuizFeedback = Awaited<ReturnType<typeof getQuizFeedbacks>>["quizFeedbacks"][number];
