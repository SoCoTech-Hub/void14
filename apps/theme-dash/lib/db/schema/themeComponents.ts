...
export type NewThemeComponentParams = z.infer<typeof insertThemeComponentParams>;
export type UpdateThemeComponentParams = z.infer<typeof updateThemeComponentParams>;
...
export type CompleteThemeComponent = Awaited<ReturnType<typeof getThemeComponents>>["themeComponents"][number];
