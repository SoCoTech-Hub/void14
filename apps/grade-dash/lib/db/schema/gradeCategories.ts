...
import { boolean, integer, varchar, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertGradeCategorySchema = createInsertSchema(gradeCategories).omit(timestamps);
export const insertGradeCategoryParams = baseSchema.extend({
...
export type UpdateGradeCategoryParams = z.infer<typeof updateGradeCategoryParams>;
...
export type CompleteGradeCategory = Awaited<ReturnType<typeof getGradeCategories>>["gradeCategories"][number];
