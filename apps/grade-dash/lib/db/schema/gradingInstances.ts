...
import { varchar, text, integer, real, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertGradingInstanceSchema = createInsertSchema(gradingInstances).omit(timestamps);
export const insertGradingInstanceParams = baseSchema.extend({
...
export type NewGradingInstanceParams = z.infer<typeof insertGradingInstanceParams>;
export type UpdateGradingInstanceParams = z.infer<typeof updateGradingInstanceParams>;
...
export type CompleteGradingInstance = Awaited<ReturnType<typeof getGradingInstances>>["gradingInstances"][number];
