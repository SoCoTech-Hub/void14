...
export const gradeOutcomesCourses = pgTable('grade_outcomes_courses', {
  ...
  gradeOutcomeId: varchar("grade_outcome_id", { length: 256 }).references(() => gradeOutcomes.id, { onDelete: "cascade" }).notNull(),
...
export const insertGradeOutcomesCourseSchema = createInsertSchema(gradeOutcomesCourses);
export const insertGradeOutcomesCourseParams = baseSchema.extend({
...
export type NewGradeOutcomesCourse = z.infer<typeof insertGradeOutcomesCourseSchema>;
export type NewGradeOutcomesCourseParams = z.infer<typeof insertGradeOutcomesCourseParams>;
export type UpdateGradeOutcomesCourseParams = z.infer<typeof updateGradeOutcomesCourseParams>;
export type GradeOutcomesCourseId = z.infer<typeof gradeOutcomesCourseIdSchema>["id"];
    
// this type infers the return from getGradeOutcomesCourses() - meaning it will include any joins
export type CompleteGradeOutcomesCourse = Awaited<ReturnType<typeof getGradeOutcomesCourses>>["gradeOutcomesCourses"][number];
