...
export const insertGradeImportNewitemSchema = createInsertSchema(gradeImportNewitems);
...
export type NewGradeImportNewitem = z.infer<typeof insertGradeImportNewitemSchema>;
export type NewGradeImportNewitemParams = z.infer<typeof insertGradeImportNewitemParams>;
export type UpdateGradeImportNewitemParams = z.infer<typeof updateGradeImportNewitemParams>;
export type GradeImportNewitemId = z.infer<typeof gradeImportNewitemIdSchema>["id"];
    
// this type infers the return from getGradeImportNewitems() - meaning it will include any joins
export type CompleteGradeImportNewitem = Awaited<ReturnType<typeof getGradeImportNewitems>>["gradeImportNewitems"][number];
