...
export const insertGradingformGuideFillingSchema = createInsertSchema(gradingformGuideFillings);
export const insertGradingformGuideFillingParams = baseSchema.extend({
...
export type GradingformGuideFilling = typeof gradingformGuideFillings.$inferSelect;
export type NewGradingformGuideFilling = z.infer<typeof insertGradingformGuideFillingSchema>;
export type NewGradingformGuideFillingParams = z.infer<typeof insertGradingformGuideFillingParams>;
export type UpdateGradingformGuideFillingParams = z.infer<typeof updateGradingformGuideFillingParams>;
export type GradingformGuideFillingId = z.infer<typeof gradingformGuideFillingIdSchema>["id"];
    
// this type infers the return from getGradingformGuideFillings() - meaning it will include any joins
export type CompleteGradingformGuideFilling = Awaited<ReturnType<typeof getGradingformGuideFillings>>["gradingformGuideFillings"][number];
