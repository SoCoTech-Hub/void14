...
import { varchar, boolean, integer, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertGradeCategoriesHistorySchema = createInsertSchema(gradeCategoriesHistories).omit(timestamps);
export const insertGradeCategoriesHistoryParams = baseSchema.extend({
...
export type GradeCategoriesHistory = typeof gradeCategoriesHistories.$inferSelect;
export type NewGradeCategoriesHistory = z.infer<typeof insertGradeCategoriesHistorySchema>;
export type NewGradeCategoriesHistoryParams = z.infer<typeof insertGradeCategoriesHistoryParams>;
export type UpdateGradeCategoriesHistoryParams = z.infer<typeof updateGradeCategoriesHistoryParams>;
export type GradeCategoriesHistoryId = z.infer<typeof gradeCategoriesHistoryIdSchema>["id"];
    
// this type infers the return from getGradeCategoriesHistories() - meaning it will include any joins
export type CompleteGradeCategoriesHistory = Awaited<ReturnType<typeof getGradeCategoriesHistories>>["gradeCategoriesHistories"][number];
