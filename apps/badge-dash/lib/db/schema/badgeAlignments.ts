...
export type NewBadgeAlignmentParams = z.infer<typeof insertBadgeAlignmentParams>
...
// this type infers the return from getBadgeAlignments() - meaning it will include any joins
export type CompleteBadgeAlignment = Awaited<
	ReturnType<typeof getBadgeAlignments>
>['badgeAlignments'][number]
