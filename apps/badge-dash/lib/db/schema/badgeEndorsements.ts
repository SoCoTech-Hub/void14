...
export const badgeEndorsements = pgTable(
	...
	(badgeEndorsements) => {
		return {
			badgeIdIndex: uniqueIndex('be_badge_id_idx').on(badgeEndorsements.badgeId)
		}
	}
)
...
// this type infers the return from getBadgeEndorsements() - meaning it will include any joins
export type CompleteBadgeEndorsement = Awaited<
	ReturnType<typeof getBadgeEndorsements>
>['badgeEndorsements'][number]
