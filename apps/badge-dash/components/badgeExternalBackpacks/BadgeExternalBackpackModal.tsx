...
import { BadgeExternalBackpack } from "@/lib/db/schema/badgeExternalBackpacks";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Badge External Backpack</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <BadgeExternalBackpackForm closeModal={closeModal} badgeExternalBackpack={badgeExternalBackpack} />
        </div>
      </DialogContent>
    </Dialog>
  );
