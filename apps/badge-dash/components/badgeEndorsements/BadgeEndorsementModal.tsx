    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Badge Endorsement</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <BadgeEndorsementForm closeModal={closeModal} badgeEndorsement={badgeEndorsement} />
        </div>
      </DialogContent>
    </Dialog>
  );
