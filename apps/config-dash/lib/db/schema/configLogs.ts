...
export const insertConfigLogSchema = createInsertSchema(configLogs).omit(timestamps);
...
// this type infers the return from getConfigLogs() - meaning it will include any joins
export type CompleteConfigLog = Awaited<ReturnType<typeof getConfigLogs>>["configLogs"][number];
