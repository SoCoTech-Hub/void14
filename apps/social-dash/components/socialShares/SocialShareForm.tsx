...
import { SocialShare, NewSocialShareParams, insertSocialShareParams } from "@/lib/db/schema/socialShares";
                ...
                >
                  ...
                  <SelectContent>
                    {socialLinks?.socialLinks.map((socialLink) => (
                      <SelectItem key={socialLink.id} value={socialLink.id.toString()}>
                        {socialLink.name}  {/* TODO: Replace with a field from the socialLink model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
