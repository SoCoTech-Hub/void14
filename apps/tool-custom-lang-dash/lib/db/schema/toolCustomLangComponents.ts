...
export const insertToolCustomLangComponentSchema = createInsertSchema(toolCustomLangComponents);
...
export type ToolCustomLangComponent = typeof toolCustomLangComponents.$inferSelect;
export type NewToolCustomLangComponent = z.infer<typeof insertToolCustomLangComponentSchema>;
export type NewToolCustomLangComponentParams = z.infer<typeof insertToolCustomLangComponentParams>;
export type UpdateToolCustomLangComponentParams = z.infer<typeof updateToolCustomLangComponentParams>;
export type ToolCustomLangComponentId = z.infer<typeof toolCustomLangComponentIdSchema>["id"];
    
// this type infers the return from getToolCustomLangComponents() - meaning it will include any joins
export type CompleteToolCustomLangComponent = Awaited<ReturnType<typeof getToolCustomLangComponents>>["toolCustomLangComponents"][number];
