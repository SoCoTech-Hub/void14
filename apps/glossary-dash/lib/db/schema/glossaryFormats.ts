...
export const glossaryFormats = pgTable('glossary_formats', {
  ...
  return {
    sortOrderIndex: uniqueIndex('sort_order_idx').on(glossaryFormats.sortOrder),
  }
});
...
export const insertGlossaryFormatParams = baseSchema.extend({
...
export type UpdateGlossaryFormatParams = z.infer<typeof updateGlossaryFormatParams>;
...
export type CompleteGlossaryFormat = Awaited<ReturnType<typeof getGlossaryFormats>>["glossaryFormats"][number];
