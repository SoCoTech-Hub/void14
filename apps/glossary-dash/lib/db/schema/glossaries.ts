...
import { boolean, varchar, timestamp, integer, text, pgTable } from "drizzle-orm/pg-core";
...
export const insertGlossarySchema = createInsertSchema(glossaries).omit(timestamps);
export const insertGlossaryParams = baseSchema.extend({
...
export type CompleteGlossary = Awaited<ReturnType<typeof getGlossaries>>["glossaries"][number];
