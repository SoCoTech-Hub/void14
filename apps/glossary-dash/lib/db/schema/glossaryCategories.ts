...
export const glossaryCategories = pgTable('glossary_categories', {
  ...
  glossaryId: varchar("glossary_id", { length: 256 }).references(() => glossaries.id, { onDelete: "cascade" }).notNull(),
...
export const insertGlossaryCategorySchema = createInsertSchema(glossaryCategories);
export const insertGlossaryCategoryParams = baseSchema.extend({
...
export type NewGlossaryCategoryParams = z.infer<typeof insertGlossaryCategoryParams>;
export type UpdateGlossaryCategoryParams = z.infer<typeof updateGlossaryCategoryParams>;
...
export type CompleteGlossaryCategory = Awaited<ReturnType<typeof getGlossaryCategories>>["glossaryCategories"][number];
