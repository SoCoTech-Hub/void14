...
export const insertGlossaryEntrySchema = createInsertSchema(glossaryEntries).omit(timestamps);
export const insertGlossaryEntryParams = baseSchema.extend({
...
export const updateGlossaryEntryParams = baseSchema.extend({
  approved: z.coerce.boolean(),
  caseSensitive: z.coerce.boolean(),
  definitionTrust: z.coerce.boolean(),
  definitionFormat: z.coerce.number(),
...
export type UpdateGlossaryEntryParams = z.infer<typeof updateGlossaryEntryParams>;
...
export type CompleteGlossaryEntry = Awaited<ReturnType<typeof getGlossaryEntries>>["glossaryEntries"][number];
