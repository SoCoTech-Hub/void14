...
// this type infers the return from getAdminpresetsAppItAs() - meaning it will include any joins
export type CompleteAdminpresetsAppItA = Awaited<
	ReturnType<typeof getAdminpresetsAppItAs>
>['adminpresetsAppItAs'][number]
