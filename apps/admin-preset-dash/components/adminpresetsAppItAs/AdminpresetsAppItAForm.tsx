...
import { AdminpresetsAppItA, NewAdminpresetsAppItAParams, insertAdminpresetsAppItAParams } from "@/lib/db/schema/adminpresetsAppItAs";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAdminpresetsAppItA({ id: adminpresetsAppItA.id })}
          >
