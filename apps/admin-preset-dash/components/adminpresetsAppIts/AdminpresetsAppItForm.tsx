...
import { AdminpresetsAppIt, NewAdminpresetsAppItParams, insertAdminpresetsAppItParams } from "@/lib/db/schema/adminpresetsAppIts";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAdminpresetsAppIt({ id: adminpresetsAppIt.id })}
          >
