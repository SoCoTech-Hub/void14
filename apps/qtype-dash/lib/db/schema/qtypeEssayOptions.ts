...
export const qtypeEssayOptions = pgTable('qtype_essay_options', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeEssayOptions.questionId),
  }
});
...
export const insertQtypeEssayOptionSchema = createInsertSchema(qtypeEssayOptions);
export const insertQtypeEssayOptionParams = baseSchema.extend({
...
export type NewQtypeEssayOptionParams = z.infer<typeof insertQtypeEssayOptionParams>;
export type UpdateQtypeEssayOptionParams = z.infer<typeof updateQtypeEssayOptionParams>;
...
export type CompleteQtypeEssayOption = Awaited<ReturnType<typeof getQtypeEssayOptions>>["qtypeEssayOptions"][number];
