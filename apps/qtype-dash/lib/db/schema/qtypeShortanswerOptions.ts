...
export const qtypeShortanswerOptions = pgTable('qtype_shortanswer_options', {
  id: varchar("id", { length: 191 }).primaryKey().$defaultFn(() => nanoid()),
  questionId: varchar("question_id", { length: 256 }).notNull(),
  useCase: boolean("use_case").notNull()
}, (qtypeShortanswerOptions) => {
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeShortanswerOptions.questionId),
  }
});
...
export const insertQtypeShortanswerOptionSchema = createInsertSchema(qtypeShortanswerOptions);
export const insertQtypeShortanswerOptionParams = baseSchema.extend({
...
export type NewQtypeShortanswerOption = z.infer<typeof insertQtypeShortanswerOptionSchema>;
export type NewQtypeShortanswerOptionParams = z.infer<typeof insertQtypeShortanswerOptionParams>;
export type UpdateQtypeShortanswerOptionParams = z.infer<typeof updateQtypeShortanswerOptionParams>;
export type QtypeShortanswerOptionId = z.infer<typeof qtypeShortanswerOptionIdSchema>["id"];
    
// this type infers the return from getQtypeShortanswerOptions() - meaning it will include any joins
export type CompleteQtypeShortanswerOption = Awaited<ReturnType<typeof getQtypeShortanswerOptions>>["qtypeShortanswerOptions"][number];
