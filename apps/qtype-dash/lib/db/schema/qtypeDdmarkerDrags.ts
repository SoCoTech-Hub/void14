...
export const qtypeDdmarkerDrags = pgTable('qtype_ddmarker_drags', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeDdmarkerDrags.questionId),
  }
});
...
export const insertQtypeDdmarkerDragSchema = createInsertSchema(qtypeDdmarkerDrags);
export const insertQtypeDdmarkerDragParams = baseSchema.extend({
...
export type NewQtypeDdmarkerDrag = z.infer<typeof insertQtypeDdmarkerDragSchema>;
export type NewQtypeDdmarkerDragParams = z.infer<typeof insertQtypeDdmarkerDragParams>;
export type UpdateQtypeDdmarkerDragParams = z.infer<typeof updateQtypeDdmarkerDragParams>;
export type QtypeDdmarkerDragId = z.infer<typeof qtypeDdmarkerDragIdSchema>["id"];
    
// this type infers the return from getQtypeDdmarkerDrags() - meaning it will include any joins
export type CompleteQtypeDdmarkerDrag = Awaited<ReturnType<typeof getQtypeDdmarkerDrags>>["qtypeDdmarkerDrags"][number];
