...
export const qtypeDdmarkers = pgTable('qtype_ddmarkers', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeDdmarkers.questionId),
  }
});
...
export const insertQtypeDdmarkerParams = baseSchema.extend({
...
export type UpdateQtypeDdmarkerParams = z.infer<typeof updateQtypeDdmarkerParams>;
...
export type CompleteQtypeDdmarker = Awaited<ReturnType<typeof getQtypeDdmarkers>>["qtypeDdmarkers"][number];
