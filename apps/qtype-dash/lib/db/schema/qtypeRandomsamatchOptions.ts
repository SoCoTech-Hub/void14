...
export const qtypeRandomsamatchOptions = pgTable('qtype_randomsamatch_options', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeRandomsamatchOptions.questionId),
  }
});
...
export const insertQtypeRandomsamatchOptionSchema = createInsertSchema(qtypeRandomsamatchOptions);
export const insertQtypeRandomsamatchOptionParams = baseSchema.extend({
...
export type QtypeRandomsamatchOption = typeof qtypeRandomsamatchOptions.$inferSelect;
export type NewQtypeRandomsamatchOption = z.infer<typeof insertQtypeRandomsamatchOptionSchema>;
export type NewQtypeRandomsamatchOptionParams = z.infer<typeof insertQtypeRandomsamatchOptionParams>;
export type UpdateQtypeRandomsamatchOptionParams = z.infer<typeof updateQtypeRandomsamatchOptionParams>;
export type QtypeRandomsamatchOptionId = z.infer<typeof qtypeRandomsamatchOptionIdSchema>["id"];
    
// this type infers the return from getQtypeRandomsamatchOptions() - meaning it will include any joins
export type CompleteQtypeRandomsamatchOption = Awaited<ReturnType<typeof getQtypeRandomsamatchOptions>>["qtypeRandomsamatchOptions"][number];
