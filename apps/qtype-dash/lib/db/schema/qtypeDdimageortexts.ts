...
export const qtypeDdimageortexts = pgTable('qtype_ddimageortexts', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeDdimageortexts.questionId),
  }
});
...
export const insertQtypeDdimageortextSchema = createInsertSchema(qtypeDdimageortexts);
export const insertQtypeDdimageortextParams = baseSchema.extend({
...
export type NewQtypeDdimageortext = z.infer<typeof insertQtypeDdimageortextSchema>;
export type NewQtypeDdimageortextParams = z.infer<typeof insertQtypeDdimageortextParams>;
export type UpdateQtypeDdimageortextParams = z.infer<typeof updateQtypeDdimageortextParams>;
export type QtypeDdimageortextId = z.infer<typeof qtypeDdimageortextIdSchema>["id"];
    
// this type infers the return from getQtypeDdimageortexts() - meaning it will include any joins
export type CompleteQtypeDdimageortext = Awaited<ReturnType<typeof getQtypeDdimageortexts>>["qtypeDdimageortexts"][number];
