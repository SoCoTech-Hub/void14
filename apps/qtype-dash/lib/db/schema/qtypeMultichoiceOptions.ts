...
export const qtypeMultichoiceOptions = pgTable('qtype_multichoice_options', {
  ...
  partiallyCorrectFeedbackFormat: integer("partially_correct_feedback_format"),
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeMultichoiceOptions.questionId),
  }
});
...
export const insertQtypeMultichoiceOptionSchema = createInsertSchema(qtypeMultichoiceOptions);
export const insertQtypeMultichoiceOptionParams = baseSchema.extend({
...
export type QtypeMultichoiceOption = typeof qtypeMultichoiceOptions.$inferSelect;
export type NewQtypeMultichoiceOption = z.infer<typeof insertQtypeMultichoiceOptionSchema>;
export type NewQtypeMultichoiceOptionParams = z.infer<typeof insertQtypeMultichoiceOptionParams>;
export type UpdateQtypeMultichoiceOptionParams = z.infer<typeof updateQtypeMultichoiceOptionParams>;
export type QtypeMultichoiceOptionId = z.infer<typeof qtypeMultichoiceOptionIdSchema>["id"];
    
// this type infers the return from getQtypeMultichoiceOptions() - meaning it will include any joins
export type CompleteQtypeMultichoiceOption = Awaited<ReturnType<typeof getQtypeMultichoiceOptions>>["qtypeMultichoiceOptions"][number];
