...
export const qtypeMatchOptions = pgTable('qtype_match_options', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(qtypeMatchOptions.questionId),
  }
});
...
export const insertQtypeMatchOptionSchema = createInsertSchema(qtypeMatchOptions);
export const insertQtypeMatchOptionParams = baseSchema.extend({
...
export type NewQtypeMatchOptionParams = z.infer<typeof insertQtypeMatchOptionParams>;
export type UpdateQtypeMatchOptionParams = z.infer<typeof updateQtypeMatchOptionParams>;
...
export type CompleteQtypeMatchOption = Awaited<ReturnType<typeof getQtypeMatchOptions>>["qtypeMatchOptions"][number];
