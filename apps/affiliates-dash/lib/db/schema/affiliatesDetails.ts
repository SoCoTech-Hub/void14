...
export const insertAffiliatesDetailSchema = createInsertSchema(affiliatesDetails);
export const insertAffiliatesDetailParams = baseSchema.extend({
...
export type NewAffiliatesDetailParams = z.infer<typeof insertAffiliatesDetailParams>;
export type UpdateAffiliatesDetailParams = z.infer<typeof updateAffiliatesDetailParams>;
export type AffiliatesDetailId = z.infer<typeof affiliatesDetailIdSchema>["id"];
    
// this type infers the return from getAffiliatesDetails() - meaning it will include any joins
export type CompleteAffiliatesDetail = Awaited<ReturnType<typeof getAffiliatesDetails>>["affiliatesDetails"][number];
