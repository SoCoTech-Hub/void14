import { boolean, text, varchar, pgTable } from "drizzle-orm/pg-core";
...
export const insertAffiliateParams = baseSchema.extend({
...
export const updateAffiliateParams = baseSchema.extend({
  isApproved: z.coerce.boolean()
}).omit({ 
  userId: true
});
...
export type CompleteAffiliate = Awaited<ReturnType<typeof getAffiliates>>["affiliates"][number];
