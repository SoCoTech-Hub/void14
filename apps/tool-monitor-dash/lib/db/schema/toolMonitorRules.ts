...
export const insertToolMonitorRuleSchema = createInsertSchema(toolMonitorRules).omit(timestamps);
export const insertToolMonitorRuleParams = baseSchema.extend({
...
export const updateToolMonitorRuleParams = baseSchema.extend({
  descriptionFormat: z.coerce.number(),
  frequency: z.coerce.number(),
  templateFormat: z.coerce.number(),
  timeWindow: z.coerce.number()
...
export type NewToolMonitorRuleParams = z.infer<typeof insertToolMonitorRuleParams>;
export type UpdateToolMonitorRuleParams = z.infer<typeof updateToolMonitorRuleParams>;
...
export type CompleteToolMonitorRule = Awaited<ReturnType<typeof getToolMonitorRules>>["toolMonitorRules"][number];
