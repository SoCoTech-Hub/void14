...
export const insertToolMonitorEventSchema = createInsertSchema(toolMonitorEvents).omit(timestamps);
...
export type NewToolMonitorEventParams = z.infer<typeof insertToolMonitorEventParams>;
export type UpdateToolMonitorEventParams = z.infer<typeof updateToolMonitorEventParams>;
...
export type CompleteToolMonitorEvent = Awaited<ReturnType<typeof getToolMonitorEvents>>["toolMonitorEvents"][number];
