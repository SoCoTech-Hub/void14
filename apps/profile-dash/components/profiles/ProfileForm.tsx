...
import { Profile, NewProfileParams, insertProfileParams } from "@/lib/db/schema/profiles";
                  ...
                  <SelectContent>
                    {addresses?.addresses.map((address) => (
                      <SelectItem key={address.id} value={address.id.toString()}>
                        {address.line1}  {/* TODO: Replace with a field from the address model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                  ...
                  <SelectContent>
                    {genders?.genders.map((gender) => (
                      <SelectItem key={gender.id} value={gender.id.toString()}>
                        {gender.name}  {/* TODO: Replace with a field from the gender model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                ...
                >
                  ...
                  <SelectContent>
                    {nextOfKins?.nextOfKins.map((nextOfKin) => (
                      <SelectItem key={nextOfKin.id} value={nextOfKin.id.toString()}>
                        {nextOfKin.name}  {/* TODO: Replace with a field from the nextOfKin model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
