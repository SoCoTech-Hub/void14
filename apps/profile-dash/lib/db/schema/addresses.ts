...
export const insertAddressSchema = createInsertSchema(addresses).omit(timestamps);
...
export type CompleteAddress = Awaited<ReturnType<typeof getAddresses>>["addresses"][number];
