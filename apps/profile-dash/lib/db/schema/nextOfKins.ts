...
export const insertNextOfKinSchema = createInsertSchema(nextOfKins).omit(timestamps);
...
export type CompleteNextOfKin = Awaited<ReturnType<typeof getNextOfKins>>["nextOfKins"][number];
