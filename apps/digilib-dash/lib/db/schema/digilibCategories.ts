...
export const insertDigilibCategorySchema = createInsertSchema(digilibCategories);
...
export type NewDigilibCategoryParams = z.infer<typeof insertDigilibCategoryParams>;
export type UpdateDigilibCategoryParams = z.infer<typeof updateDigilibCategoryParams>;
...
export type CompleteDigilibCategory = Awaited<ReturnType<typeof getDigilibCategories>>["digilibCategories"][number];
