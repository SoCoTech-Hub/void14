import { boolean, varchar, integer, pgTable } from "drizzle-orm/pg-core";
...
export const filterActives = pgTable('filter_actives', {
...
export const insertFilterActiveParams = baseSchema.extend({
...
export type CompleteFilterActive = Awaited<ReturnType<typeof getFilterActives>>["filterActives"][number];
