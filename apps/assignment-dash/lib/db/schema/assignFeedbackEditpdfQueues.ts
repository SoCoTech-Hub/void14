...
// this type infers the return from getAssignFeedbackEditpdfQueues() - meaning it will include any joins
export type CompleteAssignFeedbackEditpdfQueue = Awaited<
	ReturnType<typeof getAssignFeedbackEditpdfQueues>
>['assignFeedbackEditpdfQueues'][number]
