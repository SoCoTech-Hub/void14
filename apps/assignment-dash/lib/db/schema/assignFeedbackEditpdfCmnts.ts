import { varchar, boolean, integer, text, pgTable } from 'drizzle-orm/pg-core'
import { createInsertSchema, createSelectSchema } from 'drizzle-zod'
import { z } from 'zod'

import { type getAssignFeedbackEditpdfCmnts } from '@/lib/api/assignFeedbackEditpdfCmnts/queries'
...
// this type infers the return from getAssignFeedbackEditpdfCmnts() - meaning it will include any joins
export type CompleteAssignFeedbackEditpdfCmnt = Awaited<
	ReturnType<typeof getAssignFeedbackEditpdfCmnts>
>['assignFeedbackEditpdfCmnts'][number]
