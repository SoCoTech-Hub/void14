...
import { type getAssignFeedbackEditpdfAnnots } from '@/lib/api/assignFeedbackEditpdfAnnots/queries'
...
// this type infers the return from getAssignFeedbackEditpdfAnnots() - meaning it will include any joins
export type CompleteAssignFeedbackEditpdfAnnot = Awaited<
	ReturnType<typeof getAssignFeedbackEditpdfAnnots>
>['assignFeedbackEditpdfAnnots'][number]
