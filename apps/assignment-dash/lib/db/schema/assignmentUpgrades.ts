...
import { type getAssignmentUpgrades } from '@/lib/api/assignmentUpgrades/queries'
...
export type NewAssignmentUpgrade = z.infer<typeof insertAssignmentUpgradeSchema>
