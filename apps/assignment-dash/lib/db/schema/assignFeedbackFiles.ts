...
import { type getAssignFeedbackFiles } from '@/lib/api/assignFeedbackFiles/queries'
...
// this type infers the return from getAssignFeedbackFiles() - meaning it will include any joins
export type CompleteAssignFeedbackFile = Awaited<
	ReturnType<typeof getAssignFeedbackFiles>
>['assignFeedbackFiles'][number]
