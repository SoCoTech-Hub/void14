...
import { AssignFeedbackFile, NewAssignFeedbackFileParams, insertAssignFeedbackFileParams } from "@/lib/db/schema/assignFeedbackFiles";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAssignFeedbackFile({ id: assignFeedbackFile.id })}
          >
