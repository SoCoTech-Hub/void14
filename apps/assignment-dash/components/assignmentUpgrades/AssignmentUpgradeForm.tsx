...
import { AssignmentUpgrade, NewAssignmentUpgradeParams, insertAssignmentUpgradeParams } from "@/lib/db/schema/assignmentUpgrades";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAssignmentUpgrade({ id: assignmentUpgrade.id })}
          >
