...
import { AssignOverride, NewAssignOverrideParams, insertAssignOverrideParams } from "@/lib/db/schema/assignOverrides";
                  ...
                  <SelectContent>
                    {assigns?.assigns.map((assign) => (
                      <SelectItem key={assign.id} value={assign.id.toString()}>
                        {assign.id}  {/* TODO: Replace with a field from the assign model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
