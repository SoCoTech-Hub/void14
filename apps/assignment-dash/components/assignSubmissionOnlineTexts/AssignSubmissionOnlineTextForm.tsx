...
import { AssignSubmissionOnlineText, NewAssignSubmissionOnlineTextParams, insertAssignSubmissionOnlineTextParams } from "@/lib/db/schema/assignSubmissionOnlineTexts";
...
const AssignSubmissionOnlineTextForm = ({
  ...
  const handleSubmit = (values: NewAssignSubmissionOnlineTextParams) => {
    if (editing) {
      updateAssignSubmissionOnlineText({ ...values, id: assignSubmissionOnlineText.id });
    } else {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAssignSubmissionOnlineText({ id: assignSubmissionOnlineText.id })}
          >
