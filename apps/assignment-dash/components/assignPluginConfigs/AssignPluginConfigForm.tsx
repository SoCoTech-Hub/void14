...
import { AssignPluginConfig, NewAssignPluginConfigParams, insertAssignPluginConfigParams } from "@/lib/db/schema/assignPluginConfigs";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteAssignPluginConfig({ id: assignPluginConfig.id })}
          >
