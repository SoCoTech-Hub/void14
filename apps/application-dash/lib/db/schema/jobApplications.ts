...
import { type getJobApplications } from "@/lib/api/jobApplications/queries";
...
export const insertJobApplicationSchema = createInsertSchema(jobApplications).omit(timestamps);
...
export type NewJobApplicationParams = z.infer<typeof insertJobApplicationParams>;
...
// this type infers the return from getJobApplications() - meaning it will include any joins
export type CompleteJobApplication = Awaited<ReturnType<typeof getJobApplications>>["jobApplications"][number];
