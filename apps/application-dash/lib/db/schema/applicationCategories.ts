...
export const insertApplicationCategorySchema = createInsertSchema(applicationCategories);
...
export type NewApplicationCategory = z.infer<typeof insertApplicationCategorySchema>;
export type NewApplicationCategoryParams = z.infer<typeof insertApplicationCategoryParams>;
export type UpdateApplicationCategoryParams = z.infer<typeof updateApplicationCategoryParams>;
export type ApplicationCategoryId = z.infer<typeof applicationCategoryIdSchema>["id"];
    
// this type infers the return from getApplicationCategories() - meaning it will include any joins
export type CompleteApplicationCategory = Awaited<ReturnType<typeof getApplicationCategories>>["applicationCategories"][number];
