...
export const workshopFormNumErrors = pgTable('workshop_form_num_errors', {
  ...
  return {
    workshopIdIndex: uniqueIndex('workshop_id_idx').on(workshopFormNumErrors.workshopId),
  }
});
...
export const insertWorkshopFormNumErrorSchema = createInsertSchema(workshopFormNumErrors);
export const insertWorkshopFormNumErrorParams = baseSchema.extend({
...
export type NewWorkshopFormNumError = z.infer<typeof insertWorkshopFormNumErrorSchema>;
export type NewWorkshopFormNumErrorParams = z.infer<typeof insertWorkshopFormNumErrorParams>;
export type UpdateWorkshopFormNumErrorParams = z.infer<typeof updateWorkshopFormNumErrorParams>;
export type WorkshopFormNumErrorId = z.infer<typeof workshopFormNumErrorIdSchema>["id"];
    
// this type infers the return from getWorkshopFormNumErrors() - meaning it will include any joins
export type CompleteWorkshopFormNumError = Awaited<ReturnType<typeof getWorkshopFormNumErrors>>["workshopFormNumErrors"][number];
