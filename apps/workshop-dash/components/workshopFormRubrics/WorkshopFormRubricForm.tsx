...
import { WorkshopFormRubric, NewWorkshopFormRubricParams, insertWorkshopFormRubricParams } from "@/lib/db/schema/workshopFormRubrics";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteWorkshopFormRubric({ id: workshopFormRubric.id })}
          >
