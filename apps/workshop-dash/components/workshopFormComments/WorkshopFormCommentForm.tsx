...
import { WorkshopFormComment, NewWorkshopFormCommentParams, insertWorkshopFormCommentParams } from "@/lib/db/schema/workshopFormComments";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteWorkshopFormComment({ id: workshopFormComment.id })}
          >
