...
import { WorkshopFormNumError, NewWorkshopFormNumErrorParams, insertWorkshopFormNumErrorParams } from "@/lib/db/schema/workshopFormNumErrors";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteWorkshopFormNumError({ id: workshopFormNumError.id })}
          >
