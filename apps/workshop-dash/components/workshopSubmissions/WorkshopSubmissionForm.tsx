...
import { WorkshopSubmission, NewWorkshopSubmissionParams, insertWorkshopSubmissionParams } from "@/lib/db/schema/workshopSubmissions";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteWorkshopSubmission({ id: workshopSubmission.id })}
          >
