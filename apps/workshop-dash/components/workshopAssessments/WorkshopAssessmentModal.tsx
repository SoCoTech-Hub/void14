    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Workshop Assessment</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <WorkshopAssessmentForm closeModal={closeModal} workshopAssessment={workshopAssessment} />
        </div>
      </DialogContent>
    </Dialog>
  );
