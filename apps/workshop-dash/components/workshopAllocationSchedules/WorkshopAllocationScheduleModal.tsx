    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Workshop Allocation Schedule
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Workshop Allocation Schedule</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <WorkshopAllocationScheduleForm closeModal={closeModal} workshopAllocationSchedule={workshopAllocationSchedule} />
        </div>
      </DialogContent>
    </Dialog>
  );
