import { text, integer, real, timestamp, varchar, pgTable } from "drizzle-orm/pg-core";
...
export const insertLogQueryParams = baseSchema.extend({
...
export type CompleteLogQuery = Awaited<ReturnType<typeof getLogQueries>>["logQueries"][number];
