...
export const insertLogstoreStandardLogSchema = createInsertSchema(logstoreStandardLogs).omit(timestamps);
export const insertLogstoreStandardLogParams = baseSchema.extend({
...
export const updateLogstoreStandardLogParams = baseSchema.extend({
  anonymous: z.coerce.boolean(),
  contextLevel: z.coerce.number(),
  eduLevel: z.coerce.boolean()
}).omit({ 
...
export type NewLogstoreStandardLog = z.infer<typeof insertLogstoreStandardLogSchema>;
export type NewLogstoreStandardLogParams = z.infer<typeof insertLogstoreStandardLogParams>;
export type UpdateLogstoreStandardLogParams = z.infer<typeof updateLogstoreStandardLogParams>;
export type LogstoreStandardLogId = z.infer<typeof logstoreStandardLogIdSchema>["id"];
    
// this type infers the return from getLogstoreStandardLogs() - meaning it will include any joins
export type CompleteLogstoreStandardLog = Awaited<ReturnType<typeof getLogstoreStandardLogs>>["logstoreStandardLogs"][number];
