...
export const insertInmailParams = baseSchema.extend({
...
export const updateInmailParams = baseSchema.extend({
  draft: z.coerce.boolean(),
  reply: z.coerce.boolean()
}).omit({ 
  userId: true
...
export type CompleteInmail = Awaited<ReturnType<typeof getInmails>>["inmails"][number];
