...
export const inmailResponses = pgTable('inmail_responses', {
  id: varchar("id", { length: 191 }).primaryKey().$defaultFn(() => nanoid()),
  read: boolean("read"),
  starred: boolean("starred"),
  important: boolean("important"),
  deleted: boolean("deleted"),
  lable: varchar("lable", { length: 256 }),
  inmailId: varchar("inmail_id", { length: 256 }).references(() => inmails.id, { onDelete: "cascade" }).notNull(),
...
export const insertInmailResponseParams = baseSchema.extend({
...
export const updateInmailResponseParams = baseSchema.extend({
  read: z.coerce.boolean(),
  starred: z.coerce.boolean(),
  important: z.coerce.boolean(),
  deleted: z.coerce.boolean(),
...
export type NewInmailResponseParams = z.infer<typeof insertInmailResponseParams>;
export type UpdateInmailResponseParams = z.infer<typeof updateInmailResponseParams>;
...
export type CompleteInmailResponse = Awaited<ReturnType<typeof getInmailResponses>>["inmailResponses"][number];
