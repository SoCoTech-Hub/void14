...
import { InmailResponse, NewInmailResponseParams, insertInmailResponseParams } from "@/lib/db/schema/inmailResponses";
                ...
                >
                  ...
                  <SelectContent>
                    {inmails?.inmails.map((inmail) => (
                      <SelectItem key={inmail.id} value={inmail.id.toString()}>
                        {inmail.subject}  {/* TODO: Replace with a field from the inmail model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
