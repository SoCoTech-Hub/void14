...
import { LocalizationLanguage, NewLocalizationLanguageParams, insertLocalizationLanguageParams } from "@/lib/db/schema/localizationLanguages";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteLocalizationLanguage({ id: localizationLanguage.id })}
          >
