...
export const insertLocalizationFieldSchema = createInsertSchema(localizationFields);
...
export type NewLocalizationFieldParams = z.infer<typeof insertLocalizationFieldParams>;
export type UpdateLocalizationFieldParams = z.infer<typeof updateLocalizationFieldParams>;
export type LocalizationFieldId = z.infer<typeof localizationFieldIdSchema>["id"];
    
// this type infers the return from getLocalizationFields() - meaning it will include any joins
export type CompleteLocalizationField = Awaited<ReturnType<typeof getLocalizationFields>>["localizationFields"][number];
