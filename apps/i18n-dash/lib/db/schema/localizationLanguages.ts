...
export const localizationLanguages = pgTable('localization_languages', {
...
export const insertLocalizationLanguageSchema = createInsertSchema(localizationLanguages);
...
export type NewLocalizationLanguage = z.infer<typeof insertLocalizationLanguageSchema>;
export type NewLocalizationLanguageParams = z.infer<typeof insertLocalizationLanguageParams>;
export type UpdateLocalizationLanguageParams = z.infer<typeof updateLocalizationLanguageParams>;
export type LocalizationLanguageId = z.infer<typeof localizationLanguageIdSchema>["id"];
    
// this type infers the return from getLocalizationLanguages() - meaning it will include any joins
export type CompleteLocalizationLanguage = Awaited<ReturnType<typeof getLocalizationLanguages>>["localizationLanguages"][number];
