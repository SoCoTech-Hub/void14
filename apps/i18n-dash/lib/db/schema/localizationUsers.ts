...
export const insertLocalizationUserSchema = createInsertSchema(localizationUsers);
export const insertLocalizationUserParams = baseSchema.extend({
...
export const updateLocalizationUserParams = baseSchema.extend({
  localizationLanguageId: z.coerce.string().min(1)
}).omit({ 
  userId: true
});
...
export type NewLocalizationUserParams = z.infer<typeof insertLocalizationUserParams>;
export type UpdateLocalizationUserParams = z.infer<typeof updateLocalizationUserParams>;
...
export type CompleteLocalizationUser = Awaited<ReturnType<typeof getLocalizationUsers>>["localizationUsers"][number];
