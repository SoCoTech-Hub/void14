...
export const insertSurveyQuestionParams = baseSchema.extend({
...
export type UpdateSurveyQuestionParams = z.infer<typeof updateSurveyQuestionParams>;
...
export type CompleteSurveyQuestion = Awaited<ReturnType<typeof getSurveyQuestions>>["surveyQuestions"][number];
