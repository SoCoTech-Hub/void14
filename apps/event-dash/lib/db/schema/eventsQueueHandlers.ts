...
export const insertEventsQueueHandlerSchema = createInsertSchema(eventsQueueHandlers).omit(timestamps);
export const insertEventsQueueHandlerParams = baseSchema.extend({
...
export type NewEventsQueueHandler = z.infer<typeof insertEventsQueueHandlerSchema>;
export type NewEventsQueueHandlerParams = z.infer<typeof insertEventsQueueHandlerParams>;
export type UpdateEventsQueueHandlerParams = z.infer<typeof updateEventsQueueHandlerParams>;
export type EventsQueueHandlerId = z.infer<typeof eventsQueueHandlerIdSchema>["id"];
    
// this type infers the return from getEventsQueueHandlers() - meaning it will include any joins
export type CompleteEventsQueueHandler = Awaited<ReturnType<typeof getEventsQueueHandlers>>["eventsQueueHandlers"][number];
