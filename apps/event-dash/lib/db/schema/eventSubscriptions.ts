...
export const insertEventSubscriptionSchema = createInsertSchema(eventSubscriptions).omit(timestamps);
export const insertEventSubscriptionParams = baseSchema.extend({
...
export const updateEventSubscriptionParams = baseSchema.extend({
  pollInterval: z.coerce.number()
}).omit({ 
  userId: true
});
...
export type NewEventSubscription = z.infer<typeof insertEventSubscriptionSchema>;
export type NewEventSubscriptionParams = z.infer<typeof insertEventSubscriptionParams>;
export type UpdateEventSubscriptionParams = z.infer<typeof updateEventSubscriptionParams>;
export type EventSubscriptionId = z.infer<typeof eventSubscriptionIdSchema>["id"];
    
// this type infers the return from getEventSubscriptions() - meaning it will include any joins
export type CompleteEventSubscription = Awaited<ReturnType<typeof getEventSubscriptions>>["eventSubscriptions"][number];
