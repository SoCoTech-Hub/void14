...
export const insertEventsQueueSchema = createInsertSchema(eventsQueues).omit(timestamps);
...
export type CompleteEventsQueue = Awaited<ReturnType<typeof getEventsQueues>>["eventsQueues"][number];
