...
export const mnetRemoteRpc = pgTable('mnet_remote_rpc', {
  ...
  return {
    functionNameIndex: uniqueIndex('function_name_idx').on(mnetRemoteRpc.functionName),
  }
});
...
export const insertMnetRemoteRpcParams = baseSchema.extend({
...
export type UpdateMnetRemoteRpcParams = z.infer<typeof updateMnetRemoteRpcParams>;
...
export type CompleteMnetRemoteRpc = Awaited<ReturnType<typeof getMnetRemoteRpc>>["mnetRemoteRpc"][number];
