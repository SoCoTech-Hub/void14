...
import { type getMnetLogs } from '@/lib/api/mnetLogs/queries'
...
// this type infers the return from getMnetLogs() - meaning it will include any joins
export type CompleteMnetLog = Awaited<
	ReturnType<typeof getMnetLogs>
>['mnetLogs'][number]
