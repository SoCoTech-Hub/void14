...
export const mnetSsoAccessControls = pgTable('mnet_sso_access_controls', {
  ...
  return {
    mnetHostIdIndex: uniqueIndex('mnet_host_id_idx').on(mnetSsoAccessControls.mnetHostId),
  }
});
...
export const insertMnetSsoAccessControlSchema = createInsertSchema(mnetSsoAccessControls);
export const insertMnetSsoAccessControlParams = baseSchema.extend({
...
export type NewMnetSsoAccessControl = z.infer<typeof insertMnetSsoAccessControlSchema>;
export type NewMnetSsoAccessControlParams = z.infer<typeof insertMnetSsoAccessControlParams>;
export type UpdateMnetSsoAccessControlParams = z.infer<typeof updateMnetSsoAccessControlParams>;
export type MnetSsoAccessControlId = z.infer<typeof mnetSsoAccessControlIdSchema>["id"];
    
// this type infers the return from getMnetSsoAccessControls() - meaning it will include any joins
export type CompleteMnetSsoAccessControl = Awaited<ReturnType<typeof getMnetSsoAccessControls>>["mnetSsoAccessControls"][number];
