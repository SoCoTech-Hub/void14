...
import { WikiSynonym, NewWikiSynonymParams, insertWikiSynonymParams } from "@/lib/db/schema/wikiSynonyms";
                ...
                >
                  ...
                  <SelectContent>
                    {wikiPages?.wikiPages.map((wikiPage) => (
                      <SelectItem key={wikiPage.id} value={wikiPage.id.toString()}>
                        {wikiPage.id}  {/* TODO: Replace with a field from the wikiPage model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                ...
                >
                  ...
                  <SelectContent>
                    {wikiSubwikis?.wikiSubwikis.map((wikiSubwiki) => (
                      <SelectItem key={wikiSubwiki.wikiSubwiki.id} value={wikiSubwiki.wikiSubwiki.id.toString()}>
                        {wikiSubwiki.wikiSubwiki.id}  {/* TODO: Replace with a field from the wikiSubwiki model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
