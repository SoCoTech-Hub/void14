...
export const insertForumDiscussionSubSchema = createInsertSchema(forumDiscussionSubs);
export const insertForumDiscussionSubParams = baseSchema.extend({
...
export const updateForumDiscussionSubParams = baseSchema.extend({
  preference: z.coerce.number()
}).omit({ 
  userId: true
});
...
export type NewForumDiscussionSub = z.infer<typeof insertForumDiscussionSubSchema>;
export type NewForumDiscussionSubParams = z.infer<typeof insertForumDiscussionSubParams>;
export type UpdateForumDiscussionSubParams = z.infer<typeof updateForumDiscussionSubParams>;
export type ForumDiscussionSubId = z.infer<typeof forumDiscussionSubIdSchema>["id"];
    
// this type infers the return from getForumDiscussionSubs() - meaning it will include any joins
export type CompleteForumDiscussionSub = Awaited<ReturnType<typeof getForumDiscussionSubs>>["forumDiscussionSubs"][number];
