...
export const insertForumDiscussionSchema = createInsertSchema(forumDiscussions).omit(timestamps);
export const insertForumDiscussionParams = baseSchema.extend({
...
export const updateForumDiscussionParams = baseSchema.extend({
  assessed: z.coerce.boolean(),
  pinned: z.coerce.boolean(),
  timeEnd: z.coerce.string().min(1),
  timeLocked: z.coerce.string().min(1)
...
export type NewForumDiscussionParams = z.infer<typeof insertForumDiscussionParams>;
export type UpdateForumDiscussionParams = z.infer<typeof updateForumDiscussionParams>;
...
export type CompleteForumDiscussion = Awaited<ReturnType<typeof getForumDiscussions>>["forumDiscussions"][number];
