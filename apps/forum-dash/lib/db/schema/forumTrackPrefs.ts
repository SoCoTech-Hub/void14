...
export const insertForumTrackPrefParams = baseSchema.extend({
...
export const updateForumTrackPrefParams = baseSchema.extend({
  forumId: z.coerce.string().min(1)
}).omit({ 
  userId: true
});
...
export type NewForumTrackPrefParams = z.infer<typeof insertForumTrackPrefParams>;
export type UpdateForumTrackPrefParams = z.infer<typeof updateForumTrackPrefParams>;
...
export type CompleteForumTrackPref = Awaited<ReturnType<typeof getForumTrackPrefs>>["forumTrackPrefs"][number];
