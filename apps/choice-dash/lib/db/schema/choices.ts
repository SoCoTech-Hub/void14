...
import { type getChoices } from "@/lib/api/choices/queries";
...
export const insertChoiceParams = baseSchema.extend({
...
export type CompleteChoice = Awaited<ReturnType<typeof getChoices>>["choices"][number];
