...
export const insertChoiceOptionSchema = createInsertSchema(choiceOptions).omit(timestamps);
export const insertChoiceOptionParams = baseSchema.extend({
...
export type CompleteChoiceOption = Awaited<ReturnType<typeof getChoiceOptions>>["choiceOptions"][number];
