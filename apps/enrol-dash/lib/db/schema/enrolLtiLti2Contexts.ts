...
export const insertEnrolLtiLti2ContextSchema = createInsertSchema(enrolLtiLti2Contexts).omit(timestamps);
...
export type NewEnrolLtiLti2Context = z.infer<typeof insertEnrolLtiLti2ContextSchema>;
export type NewEnrolLtiLti2ContextParams = z.infer<typeof insertEnrolLtiLti2ContextParams>;
export type UpdateEnrolLtiLti2ContextParams = z.infer<typeof updateEnrolLtiLti2ContextParams>;
export type EnrolLtiLti2ContextId = z.infer<typeof enrolLtiLti2ContextIdSchema>["id"];
    
// this type infers the return from getEnrolLtiLti2Contexts() - meaning it will include any joins
export type CompleteEnrolLtiLti2Context = Awaited<ReturnType<typeof getEnrolLtiLti2Contexts>>["enrolLtiLti2Contexts"][number];
