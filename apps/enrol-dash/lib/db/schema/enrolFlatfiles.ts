...
export const insertEnrolFlatfileSchema = createInsertSchema(enrolFlatfiles).omit(timestamps);
...
export type UpdateEnrolFlatfileParams = z.infer<typeof updateEnrolFlatfileParams>;
...
export type CompleteEnrolFlatfile = Awaited<ReturnType<typeof getEnrolFlatfiles>>["enrolFlatfiles"][number];
