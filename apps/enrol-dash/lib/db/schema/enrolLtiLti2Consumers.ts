...
import { varchar, text, boolean, date, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertEnrolLtiLti2ConsumerSchema = createInsertSchema(enrolLtiLti2Consumers).omit(timestamps);
export const insertEnrolLtiLti2ConsumerParams = baseSchema.extend({
...
export type NewEnrolLtiLti2Consumer = z.infer<typeof insertEnrolLtiLti2ConsumerSchema>;
export type NewEnrolLtiLti2ConsumerParams = z.infer<typeof insertEnrolLtiLti2ConsumerParams>;
export type UpdateEnrolLtiLti2ConsumerParams = z.infer<typeof updateEnrolLtiLti2ConsumerParams>;
export type EnrolLtiLti2ConsumerId = z.infer<typeof enrolLtiLti2ConsumerIdSchema>["id"];
    
// this type infers the return from getEnrolLtiLti2Consumers() - meaning it will include any joins
export type CompleteEnrolLtiLti2Consumer = Awaited<ReturnType<typeof getEnrolLtiLti2Consumers>>["enrolLtiLti2Consumers"][number];
