...
export const insertEnrolLtiLti2ToolProxySchema = createInsertSchema(enrolLtiLti2ToolProxys).omit(timestamps);
...
export type NewEnrolLtiLti2ToolProxy = z.infer<typeof insertEnrolLtiLti2ToolProxySchema>;
export type NewEnrolLtiLti2ToolProxyParams = z.infer<typeof insertEnrolLtiLti2ToolProxyParams>;
export type UpdateEnrolLtiLti2ToolProxyParams = z.infer<typeof updateEnrolLtiLti2ToolProxyParams>;
export type EnrolLtiLti2ToolProxyId = z.infer<typeof enrolLtiLti2ToolProxyIdSchema>["id"];
    
// this type infers the return from getEnrolLtiLti2ToolProxys() - meaning it will include any joins
export type CompleteEnrolLtiLti2ToolProxy = Awaited<ReturnType<typeof getEnrolLtiLti2ToolProxys>>["enrolLtiLti2ToolProxys"][number];
