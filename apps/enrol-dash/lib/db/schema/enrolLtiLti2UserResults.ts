...
export const insertEnrolLtiLti2UserResultSchema = createInsertSchema(enrolLtiLti2UserResults).omit(timestamps);
...
export type EnrolLtiLti2UserResult = typeof enrolLtiLti2UserResults.$inferSelect;
export type NewEnrolLtiLti2UserResult = z.infer<typeof insertEnrolLtiLti2UserResultSchema>;
export type NewEnrolLtiLti2UserResultParams = z.infer<typeof insertEnrolLtiLti2UserResultParams>;
export type UpdateEnrolLtiLti2UserResultParams = z.infer<typeof updateEnrolLtiLti2UserResultParams>;
export type EnrolLtiLti2UserResultId = z.infer<typeof enrolLtiLti2UserResultIdSchema>["id"];
    
// this type infers the return from getEnrolLtiLti2UserResults() - meaning it will include any joins
export type CompleteEnrolLtiLti2UserResult = Awaited<ReturnType<typeof getEnrolLtiLti2UserResults>>["enrolLtiLti2UserResults"][number];
