...
import { type getEnrolLtiDeployments } from "@/lib/api/enrolLtiDeployments/queries";
...
export const insertEnrolLtiDeploymentSchema = createInsertSchema(enrolLtiDeployments).omit(timestamps);
...
export type NewEnrolLtiDeployment = z.infer<typeof insertEnrolLtiDeploymentSchema>;
export type NewEnrolLtiDeploymentParams = z.infer<typeof insertEnrolLtiDeploymentParams>;
export type UpdateEnrolLtiDeploymentParams = z.infer<typeof updateEnrolLtiDeploymentParams>;
export type EnrolLtiDeploymentId = z.infer<typeof enrolLtiDeploymentIdSchema>["id"];
    
// this type infers the return from getEnrolLtiDeployments() - meaning it will include any joins
export type CompleteEnrolLtiDeployment = Awaited<ReturnType<typeof getEnrolLtiDeployments>>["enrolLtiDeployments"][number];
