...
import { varchar, real, integer, text, date, boolean, timestamp, pgTable } from "drizzle-orm/pg-core";
import { createInsertSchema, createSelectSchema } from "drizzle-zod";
import { z } from "zod";

import { type getEnrols } from "@/lib/api/enrols/queries";

import { nanoid, timestamps } from "@/lib/utils";


export const enrols = pgTable('enrols', {
...
export const insertEnrolParams = baseSchema.extend({
...
// this type infers the return from getEnrols() - meaning it will include any joins
export type CompleteEnrol = Awaited<ReturnType<typeof getEnrols>>["enrols"][number];
