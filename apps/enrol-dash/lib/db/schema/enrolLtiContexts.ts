...
export const insertEnrolLtiContextSchema = createInsertSchema(enrolLtiContexts).omit(timestamps);
...
export type NewEnrolLtiContextParams = z.infer<typeof insertEnrolLtiContextParams>;
export type UpdateEnrolLtiContextParams = z.infer<typeof updateEnrolLtiContextParams>;
...
export type CompleteEnrolLtiContext = Awaited<ReturnType<typeof getEnrolLtiContexts>>["enrolLtiContexts"][number];
