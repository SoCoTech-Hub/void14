...
export const insertEnrolLtiResourceLinkSchema = createInsertSchema(enrolLtiResourceLinks).omit(timestamps);
...
export type NewEnrolLtiResourceLink = z.infer<typeof insertEnrolLtiResourceLinkSchema>;
export type NewEnrolLtiResourceLinkParams = z.infer<typeof insertEnrolLtiResourceLinkParams>;
export type UpdateEnrolLtiResourceLinkParams = z.infer<typeof updateEnrolLtiResourceLinkParams>;
export type EnrolLtiResourceLinkId = z.infer<typeof enrolLtiResourceLinkIdSchema>["id"];
    
// this type infers the return from getEnrolLtiResourceLinks() - meaning it will include any joins
export type CompleteEnrolLtiResourceLink = Awaited<ReturnType<typeof getEnrolLtiResourceLinks>>["enrolLtiResourceLinks"][number];
