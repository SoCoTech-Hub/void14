...
export const insertEnrolLtiAppRegistrationSchema = createInsertSchema(enrolLtiAppRegistrations).omit(timestamps);
export const insertEnrolLtiAppRegistrationParams = baseSchema.extend({
...
export type EnrolLtiAppRegistration = typeof enrolLtiAppRegistrations.$inferSelect;
export type NewEnrolLtiAppRegistration = z.infer<typeof insertEnrolLtiAppRegistrationSchema>;
export type NewEnrolLtiAppRegistrationParams = z.infer<typeof insertEnrolLtiAppRegistrationParams>;
export type UpdateEnrolLtiAppRegistrationParams = z.infer<typeof updateEnrolLtiAppRegistrationParams>;
export type EnrolLtiAppRegistrationId = z.infer<typeof enrolLtiAppRegistrationIdSchema>["id"];
    
// this type infers the return from getEnrolLtiAppRegistrations() - meaning it will include any joins
export type CompleteEnrolLtiAppRegistration = Awaited<ReturnType<typeof getEnrolLtiAppRegistrations>>["enrolLtiAppRegistrations"][number];
