import { boolean, timestamp, varchar, pgTable } from "drizzle-orm/pg-core";
...
export const insertEnrolLtiLti2ShareKeySchema = createInsertSchema(enrolLtiLti2ShareKeys);
export const insertEnrolLtiLti2ShareKeyParams = baseSchema.extend({
...
export type NewEnrolLtiLti2ShareKey = z.infer<typeof insertEnrolLtiLti2ShareKeySchema>;
export type NewEnrolLtiLti2ShareKeyParams = z.infer<typeof insertEnrolLtiLti2ShareKeyParams>;
export type UpdateEnrolLtiLti2ShareKeyParams = z.infer<typeof updateEnrolLtiLti2ShareKeyParams>;
export type EnrolLtiLti2ShareKeyId = z.infer<typeof enrolLtiLti2ShareKeyIdSchema>["id"];
    
// this type infers the return from getEnrolLtiLti2ShareKeys() - meaning it will include any joins
export type CompleteEnrolLtiLti2ShareKey = Awaited<ReturnType<typeof getEnrolLtiLti2ShareKeys>>["enrolLtiLti2ShareKeys"][number];
