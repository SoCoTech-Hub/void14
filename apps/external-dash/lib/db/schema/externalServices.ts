...
import { type getExternalServices } from "@/lib/api/externalServices/queries";
...
export const insertExternalServiceSchema = createInsertSchema(externalServices).omit(timestamps);
export const insertExternalServiceParams = baseSchema.extend({
...
export type NewExternalServiceParams = z.infer<typeof insertExternalServiceParams>;
export type UpdateExternalServiceParams = z.infer<typeof updateExternalServiceParams>;
export type ExternalServiceId = z.infer<typeof externalServiceIdSchema>["id"];
    
// this type infers the return from getExternalServices() - meaning it will include any joins
export type CompleteExternalService = Awaited<ReturnType<typeof getExternalServices>>["externalServices"][number];
