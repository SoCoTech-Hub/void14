...
export const insertExternalFunctionSchema = createInsertSchema(externalFunctions);
...
export type NewExternalFunctionParams = z.infer<typeof insertExternalFunctionParams>;
export type UpdateExternalFunctionParams = z.infer<typeof updateExternalFunctionParams>;
...
export type CompleteExternalFunction = Awaited<ReturnType<typeof getExternalFunctions>>["externalFunctions"][number];
