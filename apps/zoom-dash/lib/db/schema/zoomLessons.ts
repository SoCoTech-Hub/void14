...
export const zoomLessons = pgTable('zoom_lessons', {
...
export const insertZoomLessonParams = baseSchema.extend({
...
export const updateZoomLessonParams = baseSchema.extend({
  active: z.coerce.boolean()
}).omit({ 
  userId: true
});
...
export type CompleteZoomLesson = Awaited<ReturnType<typeof getZoomLessons>>["zoomLessons"][number];
