...
export const insertFilesReferenceParams = baseSchema.extend({
...
export type NewFilesReferenceParams = z.infer<typeof insertFilesReferenceParams>;
export type UpdateFilesReferenceParams = z.infer<typeof updateFilesReferenceParams>;
...
export type CompleteFilesReference = Awaited<ReturnType<typeof getFilesReferences>>["filesReferences"][number];
