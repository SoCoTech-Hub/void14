...
export const insertFileConversionSchema = createInsertSchema(fileConversions).omit(timestamps);
export const insertFileConversionParams = baseSchema.extend({
...
export const updateFileConversionParams = baseSchema.extend({
  status: z.coerce.boolean()
}).omit({ 
  userId: true
});
...
export type NewFileConversionParams = z.infer<typeof insertFileConversionParams>;
export type UpdateFileConversionParams = z.infer<typeof updateFileConversionParams>;
...
export type CompleteFileConversion = Awaited<ReturnType<typeof getFileConversions>>["fileConversions"][number];
