...
export const insertInfectedFileSchema = createInsertSchema(infectedFiles).omit(timestamps);
...
export type CompleteInfectedFile = Awaited<ReturnType<typeof getInfectedFiles>>["infectedFiles"][number];
