...
export const insertToolCohortRoleSchema = createInsertSchema(toolCohortRoles).omit(timestamps);
...
export type NewToolCohortRoleParams = z.infer<typeof insertToolCohortRoleParams>;
export type UpdateToolCohortRoleParams = z.infer<typeof updateToolCohortRoleParams>;
...
export type CompleteToolCohortRole = Awaited<ReturnType<typeof getToolCohortRoles>>["toolCohortRoles"][number];
