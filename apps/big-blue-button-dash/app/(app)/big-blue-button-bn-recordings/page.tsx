...
export default async function BigBlueButtonBnRecordings() {
	await checkAuth()
	const { bigBlueButtonBnRecordings } =
		await api.bigBlueButtonBnRecordings.getBigBlueButtonBnRecordings.query()
