    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Big Blue Button Bn Recording
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Big Blue Button Bn Recording</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <BigBlueButtonBnRecordingForm closeModal={closeModal} bigBlueButtonBnRecording={bigBlueButtonBnRecording} />
        </div>
      </DialogContent>
    </Dialog>
  );
