...
export const insertSupportDepartmentSchema = createInsertSchema(supportDepartments);
...
export type NewSupportDepartmentParams = z.infer<typeof insertSupportDepartmentParams>;
export type UpdateSupportDepartmentParams = z.infer<typeof updateSupportDepartmentParams>;
export type SupportDepartmentId = z.infer<typeof supportDepartmentIdSchema>["id"];
    
// this type infers the return from getSupportDepartments() - meaning it will include any joins
export type CompleteSupportDepartment = Awaited<ReturnType<typeof getSupportDepartments>>["supportDepartments"][number];
