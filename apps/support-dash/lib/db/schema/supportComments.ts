...
export const insertSupportCommentParams = baseSchema.extend({
...
export const updateSupportCommentParams = baseSchema.extend({
  supportTicketId: z.coerce.string().min(1)
}).omit({ 
  userId: true
});
...
export type NewSupportCommentParams = z.infer<typeof insertSupportCommentParams>;
export type UpdateSupportCommentParams = z.infer<typeof updateSupportCommentParams>;
...
export type CompleteSupportComment = Awaited<ReturnType<typeof getSupportComments>>["supportComments"][number];
