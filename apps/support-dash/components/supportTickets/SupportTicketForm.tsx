...
import { SupportTicket, NewSupportTicketParams, insertSupportTicketParams } from "@/lib/db/schema/supportTickets";
...
const SupportTicketForm = ({
  ...
  const { data: supportStatuses } = trpc.supportStatuses.getSupportStatuses.useQuery();
                ...
                >
                  ...
                  <SelectContent>
                    {supportTopics?.supportTopics.map((supportTopic) => (
                      <SelectItem key={supportTopic.id} value={supportTopic.id.toString()}>
                        {supportTopic.name}  {/* TODO: Replace with a field from the supportTopic model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                ...
                >
                  ...
                  <SelectContent>
                    {supportStatuses?.supportStatuses.map((supportStatus) => (
                      <SelectItem key={supportStatus.id} value={supportStatus.id.toString()}>
                        {supportStatus.name}  {/* TODO: Replace with a field from the supportStatus model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
