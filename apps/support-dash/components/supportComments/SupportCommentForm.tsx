...
import { SupportComment, NewSupportCommentParams, insertSupportCommentParams } from "@/lib/db/schema/supportComments";
...
const SupportCommentForm = ({
  ...
  const { data: supportTickets } = trpc.supportTickets.getSupportTickets.useQuery();
                ...
                >
                  ...
                  <SelectContent>
                    {supportTickets?.supportTickets.map((supportTicket) => (
                      <SelectItem key={supportTicket.id} value={supportTicket.id.toString()}>
                        {supportTicket.name}  {/* TODO: Replace with a field from the supportTicket model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
