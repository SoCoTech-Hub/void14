...
export const insertCustomFieldCategorySchema = createInsertSchema(customFieldCategories).omit(timestamps);
export const insertCustomFieldCategoryParams = baseSchema.extend({
...
export type NewCustomFieldCategory = z.infer<typeof insertCustomFieldCategorySchema>;
export type NewCustomFieldCategoryParams = z.infer<typeof insertCustomFieldCategoryParams>;
export type UpdateCustomFieldCategoryParams = z.infer<typeof updateCustomFieldCategoryParams>;
export type CustomFieldCategoryId = z.infer<typeof customFieldCategoryIdSchema>["id"];
    
// this type infers the return from getCustomFieldCategories() - meaning it will include any joins
export type CompleteCustomFieldCategory = Awaited<ReturnType<typeof getCustomFieldCategories>>["customFieldCategories"][number];
