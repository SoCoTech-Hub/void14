...
import { varchar, real, integer, text, timestamp, pgTable } from "drizzle-orm/pg-core";
import { createInsertSchema, createSelectSchema } from "drizzle-zod";
import { z } from "zod";

import { type getCustomFieldDatas } from "@/lib/api/customFieldDatas/queries";
...
export const insertCustomFieldDataSchema = createInsertSchema(customFieldDatas).omit(timestamps);
export const insertCustomFieldDataParams = baseSchema.extend({
...
export type NewCustomFieldDataParams = z.infer<typeof insertCustomFieldDataParams>;
export type UpdateCustomFieldDataParams = z.infer<typeof updateCustomFieldDataParams>;
...
export type CompleteCustomFieldData = Awaited<ReturnType<typeof getCustomFieldDatas>>["customFieldDatas"][number];
