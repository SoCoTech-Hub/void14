...
export const insertLtiToolProxySchema = createInsertSchema(ltiToolProxies).omit(timestamps);
export const insertLtiToolProxyParams = baseSchema.extend({
...
export type CompleteLtiToolProxy = Awaited<ReturnType<typeof getLtiToolProxies>>["ltiToolProxies"][number];
