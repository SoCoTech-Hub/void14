...
export const insertLtiTypeSchema = createInsertSchema(ltiTypes).omit(timestamps);
export const insertLtiTypeParams = baseSchema.extend({
...
export type CompleteLtiType = Awaited<ReturnType<typeof getLtiTypes>>["ltiTypes"][number];
