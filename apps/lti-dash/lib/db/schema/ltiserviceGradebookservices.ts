...
export const ltiserviceGradebookservices = pgTable('ltiservice_gradebookservices', {
...
export const insertLtiserviceGradebookserviceSchema = createInsertSchema(ltiserviceGradebookservices);
export const insertLtiserviceGradebookserviceParams = baseSchema.extend({}).omit({ 
  id: true
});
...
export type LtiserviceGradebookservice = typeof ltiserviceGradebookservices.$inferSelect;
export type NewLtiserviceGradebookservice = z.infer<typeof insertLtiserviceGradebookserviceSchema>;
export type NewLtiserviceGradebookserviceParams = z.infer<typeof insertLtiserviceGradebookserviceParams>;
export type UpdateLtiserviceGradebookserviceParams = z.infer<typeof updateLtiserviceGradebookserviceParams>;
export type LtiserviceGradebookserviceId = z.infer<typeof ltiserviceGradebookserviceIdSchema>["id"];
    
// this type infers the return from getLtiserviceGradebookservices() - meaning it will include any joins
export type CompleteLtiserviceGradebookservice = Awaited<ReturnType<typeof getLtiserviceGradebookservices>>["ltiserviceGradebookservices"][number];
