...
export type UpdateLtiTypesConfigParams = z.infer<typeof updateLtiTypesConfigParams>;
...
export type CompleteLtiTypesConfig = Awaited<ReturnType<typeof getLtiTypesConfigs>>["ltiTypesConfigs"][number];
