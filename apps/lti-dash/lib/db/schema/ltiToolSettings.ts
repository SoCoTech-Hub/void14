...
export const insertLtiToolSettingSchema = createInsertSchema(ltiToolSettings).omit(timestamps);
...
export type NewLtiToolSettingParams = z.infer<typeof insertLtiToolSettingParams>;
export type UpdateLtiToolSettingParams = z.infer<typeof updateLtiToolSettingParams>;
...
export type CompleteLtiToolSetting = Awaited<ReturnType<typeof getLtiToolSettings>>["ltiToolSettings"][number];
