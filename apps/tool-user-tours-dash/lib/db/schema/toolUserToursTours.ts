import { text, boolean, varchar, integer, pgTable } from "drizzle-orm/pg-core";
...
export const insertToolUserToursTourSchema = createInsertSchema(toolUserToursTours);
export const insertToolUserToursTourParams = baseSchema.extend({
...
export type NewToolUserToursTour = z.infer<typeof insertToolUserToursTourSchema>;
export type NewToolUserToursTourParams = z.infer<typeof insertToolUserToursTourParams>;
export type UpdateToolUserToursTourParams = z.infer<typeof updateToolUserToursTourParams>;
export type ToolUserToursTourId = z.infer<typeof toolUserToursTourIdSchema>["id"];
    
// this type infers the return from getToolUserToursTours() - meaning it will include any joins
export type CompleteToolUserToursTour = Awaited<ReturnType<typeof getToolUserToursTours>>["toolUserToursTours"][number];
