...
export const insertToolUserToursStepSchema = createInsertSchema(toolUserToursSteps);
export const insertToolUserToursStepParams = baseSchema.extend({
...
export type NewToolUserToursStep = z.infer<typeof insertToolUserToursStepSchema>;
export type NewToolUserToursStepParams = z.infer<typeof insertToolUserToursStepParams>;
export type UpdateToolUserToursStepParams = z.infer<typeof updateToolUserToursStepParams>;
export type ToolUserToursStepId = z.infer<typeof toolUserToursStepIdSchema>["id"];
    
// this type infers the return from getToolUserToursSteps() - meaning it will include any joins
export type CompleteToolUserToursStep = Awaited<ReturnType<typeof getToolUserToursSteps>>["toolUserToursSteps"][number];
