...
import { type getH5pLibraryDependencies } from "@/lib/api/h5pLibraryDependencies/queries";
...
export const insertH5pLibraryDependencySchema = createInsertSchema(h5pLibraryDependencies);
export const insertH5pLibraryDependencyParams = baseSchema.extend({
...
export type NewH5pLibraryDependency = z.infer<typeof insertH5pLibraryDependencySchema>;
export type NewH5pLibraryDependencyParams = z.infer<typeof insertH5pLibraryDependencyParams>;
export type UpdateH5pLibraryDependencyParams = z.infer<typeof updateH5pLibraryDependencyParams>;
export type H5pLibraryDependencyId = z.infer<typeof h5pLibraryDependencyIdSchema>["id"];
    
// this type infers the return from getH5pLibraryDependencies() - meaning it will include any joins
export type CompleteH5pLibraryDependency = Awaited<ReturnType<typeof getH5pLibraryDependencies>>["h5pLibraryDependencies"][number];
