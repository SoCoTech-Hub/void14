...
import { type getH5pLibraries } from "@/lib/api/h5pLibraries/queries";
...
export const insertH5pLibraryParams = baseSchema.extend({
...
export type CompleteH5pLibrary = Awaited<ReturnType<typeof getH5pLibraries>>["h5pLibraries"][number];
