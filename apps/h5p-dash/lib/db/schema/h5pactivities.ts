...
export const insertH5pactivitySchema = createInsertSchema(h5pactivities).omit(timestamps);
export const insertH5pactivityParams = baseSchema.extend({
...
export type CompleteH5pactivity = Awaited<ReturnType<typeof getH5pactivities>>["h5pactivities"][number];
