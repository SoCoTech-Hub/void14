...
export const insertH5pContentsLibrarySchema = createInsertSchema(h5pContentsLibraries);
export const insertH5pContentsLibraryParams = baseSchema.extend({
...
export type NewH5pContentsLibrary = z.infer<typeof insertH5pContentsLibrarySchema>;
export type NewH5pContentsLibraryParams = z.infer<typeof insertH5pContentsLibraryParams>;
export type UpdateH5pContentsLibraryParams = z.infer<typeof updateH5pContentsLibraryParams>;
export type H5pContentsLibraryId = z.infer<typeof h5pContentsLibraryIdSchema>["id"];
    
// this type infers the return from getH5pContentsLibraries() - meaning it will include any joins
export type CompleteH5pContentsLibrary = Awaited<ReturnType<typeof getH5pContentsLibraries>>["h5pContentsLibraries"][number];
