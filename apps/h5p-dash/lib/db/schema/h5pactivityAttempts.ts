...
import { integer, boolean, varchar, real, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertH5pactivityAttemptSchema = createInsertSchema(h5pactivityAttempts).omit(timestamps);
export const insertH5pactivityAttemptParams = baseSchema.extend({
...
export const updateH5pactivityAttemptParams = baseSchema.extend({
  attempt: z.coerce.number(),
  completion: z.coerce.boolean(),
  duration: z.coerce.number(),
  maxScore: z.coerce.number(),
...
export type NewH5pactivityAttempt = z.infer<typeof insertH5pactivityAttemptSchema>;
export type NewH5pactivityAttemptParams = z.infer<typeof insertH5pactivityAttemptParams>;
export type UpdateH5pactivityAttemptParams = z.infer<typeof updateH5pactivityAttemptParams>;
export type H5pactivityAttemptId = z.infer<typeof h5pactivityAttemptIdSchema>["id"];
    
// this type infers the return from getH5pactivityAttempts() - meaning it will include any joins
export type CompleteH5pactivityAttempt = Awaited<ReturnType<typeof getH5pactivityAttempts>>["h5pactivityAttempts"][number];
