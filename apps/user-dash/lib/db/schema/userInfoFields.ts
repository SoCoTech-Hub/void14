...
export const userInfoFields = pgTable('user_info_fields', {
  ...
  return {
    categoryIdIndex: uniqueIndex('category_id_idx').on(userInfoFields.categoryId),
  }
});
...
export const insertUserInfoFieldParams = baseSchema.extend({
...
export type UpdateUserInfoFieldParams = z.infer<typeof updateUserInfoFieldParams>;
...
export type CompleteUserInfoField = Awaited<ReturnType<typeof getUserInfoFields>>["userInfoFields"][number];
