...
export const insertUserPasswordResetSchema = createInsertSchema(userPasswordResets).omit(timestamps);
...
export type NewUserPasswordReset = z.infer<typeof insertUserPasswordResetSchema>;
export type NewUserPasswordResetParams = z.infer<typeof insertUserPasswordResetParams>;
export type UpdateUserPasswordResetParams = z.infer<typeof updateUserPasswordResetParams>;
export type UserPasswordResetId = z.infer<typeof userPasswordResetIdSchema>["id"];
    
// this type infers the return from getUserPasswordResets() - meaning it will include any joins
export type CompleteUserPasswordReset = Awaited<ReturnType<typeof getUserPasswordResets>>["userPasswordResets"][number];
