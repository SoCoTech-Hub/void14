...
export const insertResourceSchema = createInsertSchema(resources).omit(timestamps);
export const insertResourceParams = baseSchema.extend({
...
export type CompleteResource = Awaited<ReturnType<typeof getResources>>["resources"][number];
