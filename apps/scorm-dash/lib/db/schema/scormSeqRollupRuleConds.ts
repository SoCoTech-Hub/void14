...
export const scormSeqRollupRuleConds = pgTable('scorm_seq_rollup_rule_conds', {
  ...
  scormSeqRollupRuleId: varchar("scorm_seq_rollup_rule_id", { length: 256 }).references(() => scormSeqRollupRules.id).notNull(),
...
export const insertScormSeqRollupRuleCondSchema = createInsertSchema(scormSeqRollupRuleConds);
export const insertScormSeqRollupRuleCondParams = baseSchema.extend({
...
export type ScormSeqRollupRuleCond = typeof scormSeqRollupRuleConds.$inferSelect;
export type NewScormSeqRollupRuleCond = z.infer<typeof insertScormSeqRollupRuleCondSchema>;
export type NewScormSeqRollupRuleCondParams = z.infer<typeof insertScormSeqRollupRuleCondParams>;
export type UpdateScormSeqRollupRuleCondParams = z.infer<typeof updateScormSeqRollupRuleCondParams>;
export type ScormSeqRollupRuleCondId = z.infer<typeof scormSeqRollupRuleCondIdSchema>["id"];
    
// this type infers the return from getScormSeqRollupRuleConds() - meaning it will include any joins
export type CompleteScormSeqRollupRuleCond = Awaited<ReturnType<typeof getScormSeqRollupRuleConds>>["scormSeqRollupRuleConds"][number];
