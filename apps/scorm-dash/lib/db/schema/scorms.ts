...
import { boolean, integer, varchar, text, real, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const scorms = pgTable('scorms', {
  ...
  navPositionTop: varchar("nav_position_top", { length: 256 }),
  ...
  whatGrade: varchar("what_grade", { length: 256 }),
  width: integer("width"),
...
export const insertScormParams = baseSchema.extend({
...
export type CompleteScorm = Awaited<ReturnType<typeof getScorms>>["scorms"][number];
