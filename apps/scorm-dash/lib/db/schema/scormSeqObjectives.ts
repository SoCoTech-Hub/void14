import { real, varchar, boolean, pgTable } from "drizzle-orm/pg-core";
...
export const insertScormSeqObjectiveSchema = createInsertSchema(scormSeqObjectives);
export const insertScormSeqObjectiveParams = baseSchema.extend({
...
export type NewScormSeqObjective = z.infer<typeof insertScormSeqObjectiveSchema>;
export type NewScormSeqObjectiveParams = z.infer<typeof insertScormSeqObjectiveParams>;
export type UpdateScormSeqObjectiveParams = z.infer<typeof updateScormSeqObjectiveParams>;
export type ScormSeqObjectiveId = z.infer<typeof scormSeqObjectiveIdSchema>["id"];
    
// this type infers the return from getScormSeqObjectives() - meaning it will include any joins
export type CompleteScormSeqObjective = Awaited<ReturnType<typeof getScormSeqObjectives>>["scormSeqObjectives"][number];
