...
export const insertScormSeqRollupRuleSchema = createInsertSchema(scormSeqRollupRules);
export const insertScormSeqRollupRuleParams = baseSchema.extend({
...
export type NewScormSeqRollupRule = z.infer<typeof insertScormSeqRollupRuleSchema>;
export type NewScormSeqRollupRuleParams = z.infer<typeof insertScormSeqRollupRuleParams>;
export type UpdateScormSeqRollupRuleParams = z.infer<typeof updateScormSeqRollupRuleParams>;
export type ScormSeqRollupRuleId = z.infer<typeof scormSeqRollupRuleIdSchema>["id"];
    
// this type infers the return from getScormSeqRollupRules() - meaning it will include any joins
export type CompleteScormSeqRollupRule = Awaited<ReturnType<typeof getScormSeqRollupRules>>["scormSeqRollupRules"][number];
