...
export const reportbuilderSchedules = pgTable('reportbuilder_schedules', {
  ...
  return {
    reportIdIndex: uniqueIndex('report_id_idx').on(reportbuilderSchedules.reportId),
  }
});
...
export const insertReportbuilderScheduleSchema = createInsertSchema(reportbuilderSchedules).omit(timestamps);
export const insertReportbuilderScheduleParams = baseSchema.extend({
...
export const updateReportbuilderScheduleParams = baseSchema.extend({
  enabled: z.coerce.boolean(),
  messageFormat: z.coerce.number(),
  recurrence: z.coerce.number(),
  reportEmpty: z.coerce.boolean(),
...
export type NewReportbuilderSchedule = z.infer<typeof insertReportbuilderScheduleSchema>;
export type NewReportbuilderScheduleParams = z.infer<typeof insertReportbuilderScheduleParams>;
export type UpdateReportbuilderScheduleParams = z.infer<typeof updateReportbuilderScheduleParams>;
export type ReportbuilderScheduleId = z.infer<typeof reportbuilderScheduleIdSchema>["id"];
    
// this type infers the return from getReportbuilderSchedules() - meaning it will include any joins
export type CompleteReportbuilderSchedule = Awaited<ReturnType<typeof getReportbuilderSchedules>>["reportbuilderSchedules"][number];
