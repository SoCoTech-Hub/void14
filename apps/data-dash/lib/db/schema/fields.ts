import { varchar, text, boolean, pgTable } from "drizzle-orm/pg-core";
...
export const insertFieldParams = baseSchema.extend({
...
export type CompleteField = Awaited<ReturnType<typeof getFields>>["fields"][number];
