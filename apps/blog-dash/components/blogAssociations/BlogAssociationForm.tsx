...
import { BlogAssociation, NewBlogAssociationParams, insertBlogAssociationParams } from "@/lib/db/schema/blogAssociations";
                ...
                >
                  ...
                  <SelectContent>
                    {blogExternals?.blogExternals.map((blogExternal) => (
                      <SelectItem key={blogExternal.id} value={blogExternal.id.toString()}>
                        {blogExternal.id}  {/* TODO: Replace with a field from the blogExternal model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
