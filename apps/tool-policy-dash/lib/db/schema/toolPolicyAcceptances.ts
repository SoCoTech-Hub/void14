...
export const insertToolPolicyAcceptanceSchema = createInsertSchema(toolPolicyAcceptances).omit(timestamps);
export const insertToolPolicyAcceptanceParams = baseSchema.extend({
...
export const updateToolPolicyAcceptanceParams = baseSchema.extend({
  status: z.coerce.boolean()
}).omit({ 
  userId: true
});
...
export type NewToolPolicyAcceptance = z.infer<typeof insertToolPolicyAcceptanceSchema>;
export type NewToolPolicyAcceptanceParams = z.infer<typeof insertToolPolicyAcceptanceParams>;
export type UpdateToolPolicyAcceptanceParams = z.infer<typeof updateToolPolicyAcceptanceParams>;
export type ToolPolicyAcceptanceId = z.infer<typeof toolPolicyAcceptanceIdSchema>["id"];
    
// this type infers the return from getToolPolicyAcceptances() - meaning it will include any joins
export type CompleteToolPolicyAcceptance = Awaited<ReturnType<typeof getToolPolicyAcceptances>>["toolPolicyAcceptances"][number];
