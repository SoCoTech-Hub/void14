...
export type NewAssignUserMapping = z.infer<typeof insertAssignUserMappingSchema>
...
// this type infers the return from getAssignUserMappings() - meaning it will include any joins
export type CompleteAssignUserMapping = Awaited<
	ReturnType<typeof getAssignUserMappings>
>['assignUserMappings'][number]
