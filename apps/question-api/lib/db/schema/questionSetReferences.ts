...
export const questionSetReferences = pgTable(
	...
	(questionSetReferences) => {
		return {
			questionsContextIdIndex: uniqueIndex(
				'question_set_references_questions_context_id_idx'
			).on(questionSetReferences.questionsContextId)
		}
	}
)
...
export type CompleteQuestionSetReference = Awaited<
	ReturnType<typeof getQuestionSetReferences>
>['questionSetReferences'][number]
