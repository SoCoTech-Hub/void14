...
export const myPages = pgTable('my_pages', {
...
export const insertMyPageParams = baseSchema.extend({
...
export const updateMyPageParams = baseSchema.extend({
  private: z.coerce.boolean(),
  sortOrder: z.coerce.number()
}).omit({ 
  userId: true
...
export type CompleteMyPage = Awaited<ReturnType<typeof getMyPages>>["myPages"][number];
