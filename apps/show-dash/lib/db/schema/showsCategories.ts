...
export type UpdateShowsCategoryParams = z.infer<typeof updateShowsCategoryParams>;
...
export type CompleteShowsCategory = Awaited<ReturnType<typeof getShowsCategories>>["showsCategories"][number];
