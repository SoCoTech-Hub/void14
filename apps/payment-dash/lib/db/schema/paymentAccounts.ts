...
export const paymentAccounts = pgTable('payment_accounts', {
  ...
  return {
    contextIdIndex: uniqueIndex('context_id_idx').on(paymentAccounts.contextId),
  }
});
...
export const insertPaymentAccountSchema = createInsertSchema(paymentAccounts).omit(timestamps);
export const insertPaymentAccountParams = baseSchema.extend({
...
export type NewPaymentAccountParams = z.infer<typeof insertPaymentAccountParams>;
export type UpdatePaymentAccountParams = z.infer<typeof updatePaymentAccountParams>;
...
export type CompletePaymentAccount = Awaited<ReturnType<typeof getPaymentAccounts>>["paymentAccounts"][number];
