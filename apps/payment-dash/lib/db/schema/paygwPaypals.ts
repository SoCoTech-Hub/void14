...
export const paygwPaypals = pgTable('paygw_paypals', {
...
export const insertPaygwPaypalParams = baseSchema.extend({
...
export type CompletePaygwPaypal = Awaited<ReturnType<typeof getPaygwPaypals>>["paygwPaypals"][number];
