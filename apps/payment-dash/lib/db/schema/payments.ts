...
export const payments = pgTable('payments', {
  ...
  return {
    paymentAccountIdIndex: uniqueIndex('payment_account_id_idx').on(payments.paymentAccountId),
  }
});
...
export const insertPaymentSchema = createInsertSchema(payments).omit(timestamps);
export const insertPaymentParams = baseSchema.extend({
...
export type CompletePayment = Awaited<ReturnType<typeof getPayments>>["payments"][number];
