...
export const questionNumericalOptions = pgTable('question_numerical_options', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionNumericalOptions.questionId),
  }
});
...
export const insertQuestionNumericalOptionSchema = createInsertSchema(questionNumericalOptions);
export const insertQuestionNumericalOptionParams = baseSchema.extend({
...
export type QuestionNumericalOption = typeof questionNumericalOptions.$inferSelect;
export type NewQuestionNumericalOption = z.infer<typeof insertQuestionNumericalOptionSchema>;
export type NewQuestionNumericalOptionParams = z.infer<typeof insertQuestionNumericalOptionParams>;
export type UpdateQuestionNumericalOptionParams = z.infer<typeof updateQuestionNumericalOptionParams>;
export type QuestionNumericalOptionId = z.infer<typeof questionNumericalOptionIdSchema>["id"];
    
// this type infers the return from getQuestionNumericalOptions() - meaning it will include any joins
export type CompleteQuestionNumericalOption = Awaited<ReturnType<typeof getQuestionNumericalOptions>>["questionNumericalOptions"][number];
