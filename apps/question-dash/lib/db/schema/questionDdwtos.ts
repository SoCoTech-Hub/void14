...
export const questionDdwtos = pgTable('question_ddwtos', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionDdwtos.questionId),
  }
});
...
export const insertQuestionDdwtoParams = baseSchema.extend({
...
export type UpdateQuestionDdwtoParams = z.infer<typeof updateQuestionDdwtoParams>;
...
export type CompleteQuestionDdwto = Awaited<ReturnType<typeof getQuestionDdwtos>>["questionDdwtos"][number];
