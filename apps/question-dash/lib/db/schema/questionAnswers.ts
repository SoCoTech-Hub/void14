...
export const questionAnswers = pgTable('question_answers', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionAnswers.questionId),
  }
});
...
export const insertQuestionAnswerParams = baseSchema.extend({
...
export type UpdateQuestionAnswerParams = z.infer<typeof updateQuestionAnswerParams>;
...
export type CompleteQuestionAnswer = Awaited<ReturnType<typeof getQuestionAnswers>>["questionAnswers"][number];
