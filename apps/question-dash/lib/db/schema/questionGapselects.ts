...
export const questionGapselects = pgTable('question_gapselects', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionGapselects.questionId),
  }
});
...
export const insertQuestionGapselectSchema = createInsertSchema(questionGapselects);
export const insertQuestionGapselectParams = baseSchema.extend({
...
export type NewQuestionGapselect = z.infer<typeof insertQuestionGapselectSchema>;
export type NewQuestionGapselectParams = z.infer<typeof insertQuestionGapselectParams>;
export type UpdateQuestionGapselectParams = z.infer<typeof updateQuestionGapselectParams>;
export type QuestionGapselectId = z.infer<typeof questionGapselectIdSchema>["id"];
    
// this type infers the return from getQuestionGapselects() - meaning it will include any joins
export type CompleteQuestionGapselect = Awaited<ReturnType<typeof getQuestionGapselects>>["questionGapselects"][number];
