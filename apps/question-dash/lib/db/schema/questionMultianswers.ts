...
export const questionMultianswers = pgTable('question_multianswers', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionMultianswers.questionId),
  }
});
...
export const insertQuestionMultianswerSchema = createInsertSchema(questionMultianswers);
export const insertQuestionMultianswerParams = baseSchema.extend({
...
export type NewQuestionMultianswer = z.infer<typeof insertQuestionMultianswerSchema>;
export type NewQuestionMultianswerParams = z.infer<typeof insertQuestionMultianswerParams>;
export type UpdateQuestionMultianswerParams = z.infer<typeof updateQuestionMultianswerParams>;
export type QuestionMultianswerId = z.infer<typeof questionMultianswerIdSchema>["id"];
    
// this type infers the return from getQuestionMultianswers() - meaning it will include any joins
export type CompleteQuestionMultianswer = Awaited<ReturnType<typeof getQuestionMultianswers>>["questionMultianswers"][number];
