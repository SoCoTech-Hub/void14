import { varchar, text, integer, boolean, pgTable } from "drizzle-orm/pg-core";
...
export const questionCalculatedOptions = pgTable('question_calculated_options', {
  ...
  return {
    questionIdIndex: uniqueIndex('question_id_idx').on(questionCalculatedOptions.questionId),
  }
});
...
export const insertQuestionCalculatedOptionSchema = createInsertSchema(questionCalculatedOptions);
export const insertQuestionCalculatedOptionParams = baseSchema.extend({
...
export type QuestionCalculatedOption = typeof questionCalculatedOptions.$inferSelect;
export type NewQuestionCalculatedOption = z.infer<typeof insertQuestionCalculatedOptionSchema>;
export type NewQuestionCalculatedOptionParams = z.infer<typeof insertQuestionCalculatedOptionParams>;
export type UpdateQuestionCalculatedOptionParams = z.infer<typeof updateQuestionCalculatedOptionParams>;
export type QuestionCalculatedOptionId = z.infer<typeof questionCalculatedOptionIdSchema>["id"];
    
// this type infers the return from getQuestionCalculatedOptions() - meaning it will include any joins
export type CompleteQuestionCalculatedOption = Awaited<ReturnType<typeof getQuestionCalculatedOptions>>["questionCalculatedOptions"][number];
