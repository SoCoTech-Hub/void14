...
export const createQuestionAttemptAction = async (input: NewQuestionAttemptParams) => {
  try {
...
export const updateQuestionAttemptAction = async (input: UpdateQuestionAttemptParams) => {
  try {
