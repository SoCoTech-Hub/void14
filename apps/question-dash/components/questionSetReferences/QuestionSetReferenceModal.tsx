    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Question Set Reference</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QuestionSetReferenceForm closeModal={closeModal} questionSetReference={questionSetReference} />
        </div>
      </DialogContent>
    </Dialog>
  );
