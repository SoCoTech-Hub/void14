import { getBadgeBackpackById, getBadgeBackpacks } from "../api/badgeBackpacks/queries";
...
import { createBadgeBackpack, deleteBadgeBackpack, updateBadgeBackpack } from "../api/badgeBackpacks/mutations";
