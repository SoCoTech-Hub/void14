...
// this type infers the return from getBadgeCriteriaParams() - meaning it will include any joins
export type CompleteBadgeCriteriaParam = Awaited<
  ReturnType<typeof getBadgeCriteriaParams>
>["badgeCriteriaParams"][number];
