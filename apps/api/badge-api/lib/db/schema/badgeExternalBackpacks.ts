import { type getBadgeExternalBackpacks } from "@/lib/api/badgeExternalBackpacks/queries";
...
// this type infers the return from getBadgeExternalBackpacks() - meaning it will include any joins
export type CompleteBadgeExternalBackpack = Awaited<
  ReturnType<typeof getBadgeExternalBackpacks>
>["badgeExternalBackpacks"][number];
