...
import { type getCompetencyModuleComps } from "../../api/competencyModuleComps/queries";
...
export type CompleteCompetencyModuleComp = Awaited<
  ReturnType<typeof getCompetencyModuleComps>
>["competencyModuleComps"][number];
