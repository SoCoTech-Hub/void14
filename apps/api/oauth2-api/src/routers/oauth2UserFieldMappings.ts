import { getOauth2UserFieldMappingById, getOauth2UserFieldMappings } from "../api/oauth2UserFieldMappings/queries";
...
import { createOauth2UserFieldMapping, deleteOauth2UserFieldMapping, updateOauth2UserFieldMapping } from "../api/oauth2UserFieldMappings/mutations";
