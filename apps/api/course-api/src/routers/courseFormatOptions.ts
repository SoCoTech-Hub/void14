import { getCourseFormatOptionById, getCourseFormatOptions } from "../api/courseFormatOptions/queries";
...
import { createCourseFormatOption, deleteCourseFormatOption, updateCourseFormatOption } from "../api/courseFormatOptions/mutations";
