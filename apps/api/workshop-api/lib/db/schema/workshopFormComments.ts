import { text, integer, varchar, pgTable, uniqueIndex } from 'drizzle-orm/pg-core'
...
export const workshopFormComments = pgTable(
	...
	(workshopFormComments) => {
		return {
			workshopIdIndex: uniqueIndex('workshop_form_comments_workshop_id_idx').on(
				workshopFormComments.workshopId
			)
		}
	}
)
...
export const insertWorkshopFormCommentSchema =
	createInsertSchema(workshopFormComments)
export const insertWorkshopFormCommentParams = baseSchema
	.extend({
...
export type NewWorkshopFormComment = z.infer<
	typeof insertWorkshopFormCommentSchema
>
export type NewWorkshopFormCommentParams = z.infer<
	typeof insertWorkshopFormCommentParams
>
export type UpdateWorkshopFormCommentParams = z.infer<
	typeof updateWorkshopFormCommentParams
>
export type WorkshopFormCommentId = z.infer<
	typeof workshopFormCommentIdSchema
>['id']

// this type infers the return from getWorkshopFormComments() - meaning it will include any joins
export type CompleteWorkshopFormComment = Awaited<
	ReturnType<typeof getWorkshopFormComments>
>['workshopFormComments'][number]
