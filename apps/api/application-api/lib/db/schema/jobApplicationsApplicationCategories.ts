...
export type CompleteJobApplicationsApplicationCategory = Awaited<
  ReturnType<typeof getJobApplicationsApplicationCategories>
>["jobApplicationsApplicationCategories"][number];
