...
const revalidateAffiliatesTransactions = () =>
  revalidatePath("/affiliates-transactions");

export const createAffiliatesTransactionAction = async (
  input: NewAffiliatesTransactionParams,
) => {
  try {
...
export const updateAffiliatesTransactionAction = async (
...
export const deleteAffiliatesTransactionAction = async (
  input: AffiliatesTransactionId,
) => {
  try {
