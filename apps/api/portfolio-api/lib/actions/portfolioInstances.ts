...
const revalidatePortfolioInstances = () =>
  revalidatePath("/portfolio-instances");

export const createPortfolioInstanceAction = async (
  input: NewPortfolioInstanceParams,
) => {
  try {
...
export const updatePortfolioInstanceAction = async (
...
export const deletePortfolioInstanceAction = async (
  input: PortfolioInstanceId,
) => {
  try {
