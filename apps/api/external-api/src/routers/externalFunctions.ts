import { getExternalFunctionById, getExternalFunctions } from "../api/externalFunctions/queries";
...
import { createExternalFunction, deleteExternalFunction, updateExternalFunction } from "../api/externalFunctions/mutations";
