...
export const reportbuilderAudiences = pgTable(
  ...
  (reportbuilderAudiences) => {
    return {
      reportIdIndex: uniqueIndex("reportbuilder_audiences_report_id_idx").on(
...
export type CompleteReportbuilderAudience = Awaited<
  ReturnType<typeof getReportbuilderAudiences>
>["reportbuilderAudiences"][number];
