import { type getAnalyticsPredictions } from "@/lib/api/analyticsPredictions/queries";
...
// this type infers the return from getAnalyticsPredictions() - meaning it will include any joins
export type CompleteAnalyticsPrediction = Awaited<
  ReturnType<typeof getAnalyticsPredictions>
>["analyticsPredictions"][number];
