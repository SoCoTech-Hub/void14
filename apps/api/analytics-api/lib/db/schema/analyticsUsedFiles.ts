...
import { type getAnalyticsUsedFiles } from "../api/analyticsUsedFiles/queries";
...
export type CompleteAnalyticsUsedFile = Awaited<
  ReturnType<typeof getAnalyticsUsedFiles>
>["analyticsUsedFiles"][number];
