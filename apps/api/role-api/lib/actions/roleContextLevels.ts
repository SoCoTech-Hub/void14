...
const revalidateRoleContextLevels = () =>
  revalidatePath("/role-context-levels");

export const createRoleContextLevelAction = async (
  input: NewRoleContextLevelParams,
) => {
  try {
...
export const updateRoleContextLevelAction = async (
...
export const deleteRoleContextLevelAction = async (
  input: RoleContextLevelId,
) => {
  try {
