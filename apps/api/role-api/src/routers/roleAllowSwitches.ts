import { getRoleAllowSwitchById, getRoleAllowSwitches } from "../api/roleAllowSwitches/queries";
...
import { createRoleAllowSwitch, deleteRoleAllowSwitch, updateRoleAllowSwitch } from "../api/roleAllowSwitches/mutations";
