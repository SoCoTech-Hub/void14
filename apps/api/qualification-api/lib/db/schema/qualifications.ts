...
import { type getQualifications } from "../../api/qualifications/queries";
...
export const insertQualificationParams = baseSchema
  .extend({
...
export type UpdateQualificationParams = z.infer<
  typeof updateQualificationParams
>;
...
export type CompleteQualification = Awaited<
  ReturnType<typeof getQualifications>
