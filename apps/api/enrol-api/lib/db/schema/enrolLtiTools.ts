...
import { type getEnrolLtiTools } from "../../api/enrolLtiTools/queries";
...
export const insertEnrolLtiToolSchema =
  createInsertSchema(enrolLtiTools).omit(timestamps);
export const insertEnrolLtiToolParams = baseSchema
  .extend({
