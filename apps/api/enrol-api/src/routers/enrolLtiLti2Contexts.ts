import { getEnrolLtiLti2ContextById, getEnrolLtiLti2Contexts } from "../api/enrolLtiLti2Contexts/queries";
...
import { createEnrolLtiLti2Context, deleteEnrolLtiLti2Context, updateEnrolLtiLti2Context } from "../api/enrolLtiLti2Contexts/mutations";
