...
import { eq, and } from "@soco/h5p-db";
import { getUserAuth } from "@soco/auth-service";
import { type H5pactivityAttemptId, h5pactivityAttemptIdSchema, h5pactivityAttempts } from "@soco/h5p-db/schema/h5pactivityAttempts";
