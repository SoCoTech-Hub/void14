import { getMnetRemoteRpcById, getMnetRemoteRpc } from "../api/mnetRemoteRpc/queries";
...
import { createMnetRemoteRpc, deleteMnetRemoteRpc, updateMnetRemoteRpc } from "../api/mnetRemoteRpc/mutations";
