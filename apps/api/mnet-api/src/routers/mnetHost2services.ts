import { getMnetHost2serviceById, getMnetHost2services } from "../api/mnetHost2services/queries";
...
import { createMnetHost2service, deleteMnetHost2service, updateMnetHost2service } from "../api/mnetHost2services/mutations";
