...
import { type MnetServiceEnrolEnrolmentId, mnetServiceEnrolEnrolmentIdSchema, mnetServiceEnrolEnrolments } from "@soco/mnet-db/schema/mnetServiceEnrolEnrolments";
