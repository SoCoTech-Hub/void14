...
export const mnetHost2services = pgTable(
  "mnet_host2services",
  {
  ...
  (mnetHost2services) => {
    return {
      mnetHostIdIndex: uniqueIndex("mnet_host2services_mnet_host_id_idx").on(
        mnetHost2services.mnetHostId,
      ),
    };
  },
);
...
export const insertMnetHost2serviceSchema =
  createInsertSchema(mnetHost2services);
export const insertMnetHost2serviceParams = baseSchema
  .extend({
...
export type NewMnetHost2serviceParams = z.infer<
  typeof insertMnetHost2serviceParams
>;
export type UpdateMnetHost2serviceParams = z.infer<
...
export type CompleteMnetHost2service = Awaited<
  ReturnType<typeof getMnetHost2services>
>["mnetHost2services"][number];
