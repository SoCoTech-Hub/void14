import { getForumDiscussionById, getForumDiscussions } from "../api/forumDiscussions/queries";
...
import { createForumDiscussion, deleteForumDiscussion, updateForumDiscussion } from "../api/forumDiscussions/mutations";
