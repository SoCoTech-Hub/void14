import { getBigBlueButtonBnById, getBigBlueButtonBns } from "../api/bigBlueButtonBns/queries";
...
import { createBigBlueButtonBn, deleteBigBlueButtonBn, updateBigBlueButtonBn } from "../api/bigBlueButtonBns/mutations";
