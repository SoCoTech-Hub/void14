...
import { type CompetencyTemplateCohortId, competencyTemplateCohortIdSchema, competencyTemplateCohorts } from "@soco/competency-db/schema/competencyTemplateCohorts";
