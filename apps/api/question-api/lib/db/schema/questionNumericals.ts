...
import { type getQuestionNumericals } from "../api/questionNumericals/queries";
...
export const questionNumericals = pgTable(
  ...
  (questionNumericals) => {
    return {
      questionIdIndex: uniqueIndex("question_numericals_question_id_idx").on(
...
export type NewQuestionNumerical = z.infer<
  typeof insertQuestionNumericalSchema
>;
