...
export const insertQuestionSchema =
  createInsertSchema(questions).omit(timestamps);
export const insertQuestionParams = baseSchema
  .extend({
...
export const updateQuestionParams = baseSchema
  .extend({
    defaultMark: z.coerce.number(),
    generalFeedbackFormat: z.coerce.number(),
    length: z.coerce.number(),
...
export type CompleteQuestion = Awaited<
