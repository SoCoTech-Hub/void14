...
export const insertToolRecyclebinCourseSchema = createInsertSchema(toolRecyclebinCourses).omit(timestamps);
...
export type NewToolRecyclebinCourse = z.infer<typeof insertToolRecyclebinCourseSchema>;
export type NewToolRecyclebinCourseParams = z.infer<typeof insertToolRecyclebinCourseParams>;
export type UpdateToolRecyclebinCourseParams = z.infer<typeof updateToolRecyclebinCourseParams>;
export type ToolRecyclebinCourseId = z.infer<typeof toolRecyclebinCourseIdSchema>["id"];
    
// this type infers the return from getToolRecyclebinCourses() - meaning it will include any joins
export type CompleteToolRecyclebinCourse = Awaited<ReturnType<typeof getToolRecyclebinCourses>>["toolRecyclebinCourses"][number];
