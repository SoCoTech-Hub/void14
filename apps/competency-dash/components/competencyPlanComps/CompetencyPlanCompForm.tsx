...
import { CompetencyPlanComp, NewCompetencyPlanCompParams, insertCompetencyPlanCompParams } from "@/lib/db/schema/competencyPlanComps";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyPlanComp({ id: competencyPlanComp.id })}
          >
