...
import { Competency, NewCompetencyParams, insertCompetencyParams } from "@/lib/db/schema/competencies";
...
const CompetencyForm = ({
  ...
  const { data: competencyFrameworks } = trpc.competencyFrameworks.getCompetencyFrameworks.useQuery();
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Competency Framework Id</FormLabel>
                ...
                >
                  ...
                  <SelectContent>
                    {competencyFrameworks?.competencyFrameworks.map((competencyFramework) => (
                      <SelectItem key={competencyFramework.id} value={competencyFramework.id.toString()}>
                        {competencyFramework.id}  {/* TODO: Replace with a field from the competencyFramework model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
