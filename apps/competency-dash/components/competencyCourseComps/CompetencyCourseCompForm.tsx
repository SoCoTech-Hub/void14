...
import { CompetencyCourseComp, NewCompetencyCourseCompParams, insertCompetencyCourseCompParams } from "@/lib/db/schema/competencyCourseComps";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyCourseComp({ id: competencyCourseComp.id })}
          >
