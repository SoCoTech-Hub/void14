...
import { CompetencyEvidence, NewCompetencyEvidenceParams, insertCompetencyEvidenceParams } from "@/lib/db/schema/competencyEvidences";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyEvidence({ id: competencyEvidence.id })}
          >
