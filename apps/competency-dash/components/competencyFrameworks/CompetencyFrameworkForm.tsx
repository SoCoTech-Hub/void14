...
import { CompetencyFramework, NewCompetencyFrameworkParams, insertCompetencyFrameworkParams } from "@/lib/db/schema/competencyFrameworks";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyFramework({ id: competencyFramework.id })}
          >
