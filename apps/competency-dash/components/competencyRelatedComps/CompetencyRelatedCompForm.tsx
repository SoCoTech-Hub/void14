...
import { CompetencyRelatedComp, NewCompetencyRelatedCompParams, insertCompetencyRelatedCompParams } from "@/lib/db/schema/competencyRelatedComps";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyRelatedComp({ id: competencyRelatedComp.id })}
          >
