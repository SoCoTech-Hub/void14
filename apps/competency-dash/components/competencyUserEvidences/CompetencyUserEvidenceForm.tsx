...
import { CompetencyUserEvidence, NewCompetencyUserEvidenceParams, insertCompetencyUserEvidenceParams } from "@/lib/db/schema/competencyUserEvidences";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyUserEvidence({ id: competencyUserEvidence.id })}
          >
