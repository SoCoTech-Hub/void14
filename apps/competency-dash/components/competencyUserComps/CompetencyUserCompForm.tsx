...
import { CompetencyUserComp, NewCompetencyUserCompParams, insertCompetencyUserCompParams } from "@/lib/db/schema/competencyUserComps";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyUserComp({ id: competencyUserComp.id })}
          >
