    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Competency Template Comp</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <CompetencyTemplateCompForm closeModal={closeModal} competencyTemplateComp={competencyTemplateComp} />
        </div>
      </DialogContent>
    </Dialog>
  );
