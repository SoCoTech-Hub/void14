...
import { CompetencyTemplateComp, NewCompetencyTemplateCompParams, insertCompetencyTemplateCompParams } from "@/lib/db/schema/competencyTemplateComps";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteCompetencyTemplateComp({ id: competencyTemplateComp.id })}
          >
