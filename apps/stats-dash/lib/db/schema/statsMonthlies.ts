...
export const insertStatsMonthlyParams = baseSchema.extend({
...
export type CompleteStatsMonthly = Awaited<ReturnType<typeof getStatsMonthlies>>["statsMonthlies"][number];
