...
export const insertStatsUserWeeklySchema = createInsertSchema(statsUserWeeklies);
export const insertStatsUserWeeklyParams = baseSchema.extend({
...
export const updateStatsUserWeeklyParams = baseSchema.extend({
  timeEnd: z.coerce.string().min(1)
}).omit({ 
  userId: true
});
...
export type NewStatsUserWeeklyParams = z.infer<typeof insertStatsUserWeeklyParams>;
export type UpdateStatsUserWeeklyParams = z.infer<typeof updateStatsUserWeeklyParams>;
...
export type CompleteStatsUserWeekly = Awaited<ReturnType<typeof getStatsUserWeeklies>>["statsUserWeeklies"][number];
