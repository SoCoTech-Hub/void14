...
export const blocks = pgTable('blocks', {
  ...
  return {
    cronIdIndex: uniqueIndex('cron_id_idx').on(blocks.cronId),
  }
});
...
export const insertBlockParams = baseSchema.extend({
...
export type CompleteBlock = Awaited<ReturnType<typeof getBlocks>>["blocks"][number];
