    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } User Last Access</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <UserLastAccessForm closeModal={closeModal} userLastAccess={userLastAccess} />
        </div>
      </DialogContent>
    </Dialog>
  );
