...
import { CompetencyUserEvidenceComp, NewCompetencyUserEvidenceCompParams, insertCompetencyUserEvidenceCompParams } from "@soco/competency-db/schema/competencyUserEvidenceComps";
