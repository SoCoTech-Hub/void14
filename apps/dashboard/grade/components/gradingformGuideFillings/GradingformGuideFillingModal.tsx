...
import { GradingformGuideFilling } from "@/lib/db/schema/gradingformGuideFillings";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Gradingform Guide Filling</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <GradingformGuideFillingForm closeModal={closeModal} gradingformGuideFilling={gradingformGuideFilling} />
        </div>
      </DialogContent>
    </Dialog>
  );
