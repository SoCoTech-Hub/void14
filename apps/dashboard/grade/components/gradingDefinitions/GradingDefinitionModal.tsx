    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Grading Definition</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <GradingDefinitionForm closeModal={closeModal} gradingDefinition={gradingDefinition} />
        </div>
      </DialogContent>
    </Dialog>
  );
