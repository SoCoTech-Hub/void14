    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Grade Outcomes History</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <GradeOutcomesHistoryForm closeModal={closeModal} gradeOutcomesHistory={gradeOutcomesHistory} />
        </div>
      </DialogContent>
    </Dialog>
  );
