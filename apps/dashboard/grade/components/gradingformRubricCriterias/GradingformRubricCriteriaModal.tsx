...
import { GradingformRubricCriteria } from "@/lib/db/schema/gradingformRubricCriterias";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Gradingform Rubric Criteria</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <GradingformRubricCriteriaForm closeModal={closeModal} gradingformRubricCriteria={gradingformRubricCriteria} />
        </div>
      </DialogContent>
    </Dialog>
  );
