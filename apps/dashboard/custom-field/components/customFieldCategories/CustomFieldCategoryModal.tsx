    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Custom Field Category</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <CustomFieldCategoryForm closeModal={closeModal} customFieldCategory={customFieldCategory} />
        </div>
      </DialogContent>
    </Dialog>
  );
