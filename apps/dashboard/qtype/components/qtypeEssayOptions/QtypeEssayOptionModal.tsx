    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Qtype Essay Option</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QtypeEssayOptionForm closeModal={closeModal} qtypeEssayOption={qtypeEssayOption} />
        </div>
      </DialogContent>
    </Dialog>
  );
