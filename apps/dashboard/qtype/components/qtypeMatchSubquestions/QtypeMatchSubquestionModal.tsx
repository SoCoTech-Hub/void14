    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Qtype Match Subquestion</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QtypeMatchSubquestionForm closeModal={closeModal} qtypeMatchSubquestion={qtypeMatchSubquestion} />
        </div>
      </DialogContent>
    </Dialog>
  );
