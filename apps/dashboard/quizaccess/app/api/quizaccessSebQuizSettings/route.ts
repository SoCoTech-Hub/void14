...
export async function POST(req: Request) {
  try {
    const validatedData = insertQuizaccessSebQuizSettingParams.parse(await req.json());
    const { quizaccessSebQuizSetting } = await createQuizaccessSebQuizSetting(validatedData);
...
export async function PUT(req: Request) {
  try {
    ...
    const validatedData = updateQuizaccessSebQuizSettingParams.parse(await req.json());
    const validatedParams = quizaccessSebQuizSettingIdSchema.parse({ id });

    const { quizaccessSebQuizSetting } = await updateQuizaccessSebQuizSetting(validatedParams.id, validatedData);
...
export async function DELETE(req: Request) {
  try {
    ...
    const validatedParams = quizaccessSebQuizSettingIdSchema.parse({ id });
    const { quizaccessSebQuizSetting } = await deleteQuizaccessSebQuizSetting(validatedParams.id);
