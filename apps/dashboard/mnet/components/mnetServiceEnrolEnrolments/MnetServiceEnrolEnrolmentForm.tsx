...
import { MnetServiceEnrolEnrolment, NewMnetServiceEnrolEnrolmentParams, insertMnetServiceEnrolEnrolmentParams } from "@soco/mnet-db/schema/mnetServiceEnrolEnrolments";
