    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Mnet Sso Access Control</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <MnetSsoAccessControlForm closeModal={closeModal} mnetSsoAccessControl={mnetSsoAccessControl} />
        </div>
      </DialogContent>
    </Dialog>
  );
