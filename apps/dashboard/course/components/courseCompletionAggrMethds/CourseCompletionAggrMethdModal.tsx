    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Course Completion Aggr Methd
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Course Completion Aggr Methd</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <CourseCompletionAggrMethdForm closeModal={closeModal} courseCompletionAggrMethd={courseCompletionAggrMethd} />
        </div>
      </DialogContent>
    </Dialog>
  );
