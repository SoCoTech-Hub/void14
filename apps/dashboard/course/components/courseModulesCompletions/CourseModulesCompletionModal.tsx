    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Course Modules Completion</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <CourseModulesCompletionForm closeModal={closeModal} courseModulesCompletion={courseModulesCompletion} />
        </div>
      </DialogContent>
    </Dialog>
  );
