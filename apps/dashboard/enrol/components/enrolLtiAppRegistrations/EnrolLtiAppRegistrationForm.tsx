...
import { EnrolLtiAppRegistration, NewEnrolLtiAppRegistrationParams, insertEnrolLtiAppRegistrationParams } from "@soco/enrol-db/schema/enrolLtiAppRegistrations";
