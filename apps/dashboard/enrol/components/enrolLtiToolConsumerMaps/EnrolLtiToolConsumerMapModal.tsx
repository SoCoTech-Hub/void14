    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Enrol Lti Tool Consumer Map
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Enrol Lti Tool Consumer Map</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <EnrolLtiToolConsumerMapForm closeModal={closeModal} enrolLtiToolConsumerMap={enrolLtiToolConsumerMap} />
        </div>
      </DialogContent>
    </Dialog>
  );
