    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Ltiservice Gradebookservice
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Ltiservice Gradebookservice</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <LtiserviceGradebookserviceForm closeModal={closeModal} ltiserviceGradebookservice={ltiserviceGradebookservice} />
        </div>
      </DialogContent>
    </Dialog>
  );
