    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Lti Access Token</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <LtiAccessTokenForm closeModal={closeModal} ltiAccessToken={ltiAccessToken} />
        </div>
      </DialogContent>
    </Dialog>
  );
