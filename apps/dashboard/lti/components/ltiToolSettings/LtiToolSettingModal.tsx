    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Lti Tool Setting</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <LtiToolSettingForm closeModal={closeModal} ltiToolSetting={ltiToolSetting} />
        </div>
      </DialogContent>
    </Dialog>
  );
