...
export async function POST(req: Request) {
  try {
    const validatedData = insertLtiserviceGradebookserviceParams.parse(await req.json());
    const { ltiserviceGradebookservice } = await createLtiserviceGradebookservice(validatedData);
...
export async function PUT(req: Request) {
  try {
    ...
    const validatedData = updateLtiserviceGradebookserviceParams.parse(await req.json());
    const validatedParams = ltiserviceGradebookserviceIdSchema.parse({ id });

    const { ltiserviceGradebookservice } = await updateLtiserviceGradebookservice(validatedParams.id, validatedData);
...
export async function DELETE(req: Request) {
  try {
    ...
    const validatedParams = ltiserviceGradebookserviceIdSchema.parse({ id });
    const { ltiserviceGradebookservice } = await deleteLtiserviceGradebookservice(validatedParams.id);
