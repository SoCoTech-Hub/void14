    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Messageinbound Messagelist
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Messageinbound Messagelist</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <MessageinboundMessagelistForm closeModal={closeModal} messageinboundMessagelist={messageinboundMessagelist} />
        </div>
      </DialogContent>
    </Dialog>
  );
