...
import { MessageContactRequest } from "@/lib/db/schema/messageContactRequests";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Message Contact Request</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <MessageContactRequestForm closeModal={closeModal} messageContactRequest={messageContactRequest} />
        </div>
      </DialogContent>
    </Dialog>
  );
