    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Assign Feedback Editpdf Quick
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Assign Feedback Editpdf Quick</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <AssignFeedbackEditpdfQuickForm closeModal={closeModal} assignFeedbackEditpdfQuick={assignFeedbackEditpdfQuick} />
        </div>
      </DialogContent>
    </Dialog>
  );
