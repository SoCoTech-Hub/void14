    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Localization Translation</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <LocalizationTranslationForm closeModal={closeModal} localizationTranslation={localizationTranslation} />
        </div>
      </DialogContent>
    </Dialog>
  );
