    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Analytics Train Sample</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <AnalyticsTrainSampleForm closeModal={closeModal} analyticsTrainSample={analyticsTrainSample} />
        </div>
      </DialogContent>
    </Dialog>
  );
