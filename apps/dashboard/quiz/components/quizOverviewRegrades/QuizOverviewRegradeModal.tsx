    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Quiz Overview Regrade</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QuizOverviewRegradeForm closeModal={closeModal} quizOverviewRegrade={quizOverviewRegrade} />
        </div>
      </DialogContent>
    </Dialog>
  );
