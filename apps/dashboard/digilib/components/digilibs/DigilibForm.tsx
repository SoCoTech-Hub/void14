...
const DigilibForm = ({
	...
	const { data: digilibCategories } =
		trpc.digilibCategories.getDigilibCategories.useQuery()
						...
						<FormItem>
							...
							<FormControl>
								...
								>
									...
									<SelectContent>
										{digilibCategories?.digilibCategories.map(
											(digilibCategory) => (
												<SelectItem
													key={digilibCategory.id}
													value={digilibCategory.id.toString()}
												>
													{digilibCategory.name}{' '}
													{/* TODO: Replace with a field from the digilibCategory model */}
												</SelectItem>
											)
										)}
									</SelectContent>
