    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Workshop Form Rubric Config</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <WorkshopFormRubricConfigForm closeModal={closeModal} workshopFormRubricConfig={workshopFormRubricConfig} />
        </div>
      </DialogContent>
    </Dialog>
  );
