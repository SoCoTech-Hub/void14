...
import { ToolDataprivacyPurpose, NewToolDataprivacyPurposeParams, insertToolDataprivacyPurposeParams } from "@soco/tool-data-privacy-db/schema/toolDataprivacyPurposes";
