    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Tool Dataprivacy Ctx Level
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Tool Dataprivacy Ctx Level</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <ToolDataprivacyCtxLevelForm closeModal={closeModal} toolDataprivacyCtxLevel={toolDataprivacyCtxLevel} />
        </div>
      </DialogContent>
    </Dialog>
  );
