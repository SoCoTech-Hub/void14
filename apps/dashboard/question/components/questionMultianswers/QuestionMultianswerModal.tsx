    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Question Multianswer</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QuestionMultianswerForm closeModal={closeModal} questionMultianswer={questionMultianswer} />
        </div>
      </DialogContent>
    </Dialog>
  );
