    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Question Statistic</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QuestionStatisticForm closeModal={closeModal} questionStatistic={questionStatistic} />
        </div>
      </DialogContent>
    </Dialog>
  );
