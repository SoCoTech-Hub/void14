    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Question Response Count</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <QuestionResponseCountForm closeModal={closeModal} questionResponseCount={questionResponseCount} />
        </div>
      </DialogContent>
    </Dialog>
  );
