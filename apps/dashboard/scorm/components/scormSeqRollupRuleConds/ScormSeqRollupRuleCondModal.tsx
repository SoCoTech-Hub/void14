    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      { emptyState ? (
          <Button>
            ...
            New Scorm Seq Rollup Rule Cond
          </Button>
        ) : (
        <Button
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Scorm Seq Rollup Rule Cond</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <ScormSeqRollupRuleCondForm closeModal={closeModal} scormSeqRollupRuleCond={scormSeqRollupRuleCond} />
        </div>
      </DialogContent>
    </Dialog>
  );
