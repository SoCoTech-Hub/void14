...
export const registrationHubs = pgTable('registration_hubs', {
...
export const insertRegistrationHubSchema = createInsertSchema(registrationHubs).omit(timestamps);
export const insertRegistrationHubParams = baseSchema.extend({
...
export type NewRegistrationHubParams = z.infer<typeof insertRegistrationHubParams>;
export type UpdateRegistrationHubParams = z.infer<typeof updateRegistrationHubParams>;
...
export type CompleteRegistrationHub = Awaited<ReturnType<typeof getRegistrationHubs>>["registrationHubs"][number];
