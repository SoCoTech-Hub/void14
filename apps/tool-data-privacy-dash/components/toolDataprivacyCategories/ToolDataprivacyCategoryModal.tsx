    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Tool Dataprivacy Category</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <ToolDataprivacyCategoryForm closeModal={closeModal} toolDataprivacyCategory={toolDataprivacyCategory} />
        </div>
      </DialogContent>
    </Dialog>
  );
