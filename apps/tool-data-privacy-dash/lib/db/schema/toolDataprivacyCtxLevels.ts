...
export const toolDataprivacyCtxLevels = pgTable('tool_dataprivacy_ctx_levels', {
  ...
  toolDataprivacyCategoryId: varchar("tool_dataprivacy_category_id", { length: 256 }).references(() => toolDataprivacyCategories.id).notNull(),
...
export const insertToolDataprivacyCtxLevelSchema = createInsertSchema(toolDataprivacyCtxLevels).omit(timestamps);
export const insertToolDataprivacyCtxLevelParams = baseSchema.extend({
...
export const updateToolDataprivacyCtxLevelParams = baseSchema.extend({
  toolDataprivacyCategoryId: z.coerce.string().min(1),
  toolDataprivacyPurposeId: z.coerce.string().min(1)
}).omit({ 
  userId: true
...
export type ToolDataprivacyCtxLevel = typeof toolDataprivacyCtxLevels.$inferSelect;
export type NewToolDataprivacyCtxLevel = z.infer<typeof insertToolDataprivacyCtxLevelSchema>;
export type NewToolDataprivacyCtxLevelParams = z.infer<typeof insertToolDataprivacyCtxLevelParams>;
export type UpdateToolDataprivacyCtxLevelParams = z.infer<typeof updateToolDataprivacyCtxLevelParams>;
export type ToolDataprivacyCtxLevelId = z.infer<typeof toolDataprivacyCtxLevelIdSchema>["id"];
    
// this type infers the return from getToolDataprivacyCtxLevels() - meaning it will include any joins
export type CompleteToolDataprivacyCtxLevel = Awaited<ReturnType<typeof getToolDataprivacyCtxLevels>>["toolDataprivacyCtxLevels"][number];
