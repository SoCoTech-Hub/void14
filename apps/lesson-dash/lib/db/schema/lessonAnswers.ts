...
import { text, integer, boolean, varchar, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertLessonAnswerSchema = createInsertSchema(lessonAnswers).omit(timestamps);
export const insertLessonAnswerParams = baseSchema.extend({
...
// this type infers the return from getLessonAnswers() - meaning it will include any joins
export type CompleteLessonAnswer = Awaited<ReturnType<typeof getLessonAnswers>>["lessonAnswers"][number];
