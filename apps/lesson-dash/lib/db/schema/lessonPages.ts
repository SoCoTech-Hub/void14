...
export const insertLessonPageSchema = createInsertSchema(lessonPages).omit(timestamps);
export const insertLessonPageParams = baseSchema.extend({
...
export type CompleteLessonPage = Awaited<ReturnType<typeof getLessonPages>>["lessonPages"][number];
