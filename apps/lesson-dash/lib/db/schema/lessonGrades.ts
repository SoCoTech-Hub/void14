...
export const insertLessonGradeParams = baseSchema.extend({
...
export const updateLessonGradeParams = baseSchema.extend({
  completed: z.coerce.string().min(1),
  grade: z.coerce.number(),
  late: z.coerce.boolean(),
  lessonId: z.coerce.string().min(1)
...
export type CompleteLessonGrade = Awaited<ReturnType<typeof getLessonGrades>>["lessonGrades"][number];
