...
import { Lesson, NewLessonParams, insertLessonParams } from "@/lib/db/schema/lessons";
...
const LessonForm = ({
  ...
  const onSuccess = async (action: "create" | "update" | "delete",
    ...
    await utils.lessons.getLessons.invalidate();
    router.refresh();
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className={"space-y-8"}>
        ...
        <FormField
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Completion End Reached</FormLabel>
                <br />
            <FormControl>
              <Checkbox {...field} checked={!!field.value} onCheckedChange={field.onChange} value={""} />
            </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Completion Time Spent</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="displayLeft"
          render={({ field }) => (<FormItem>
              <FormLabel>Display Left</FormLabel>
                <br />
            <FormControl>
              <Checkbox {...field} checked={!!field.value} onCheckedChange={field.onChange} value={""} />
            </FormControl>
        ...
        <FormField
          ...
          name="displayLeftIf"
          render={({ field }) => (<FormItem>
              <FormLabel>Display Left If</FormLabel>
                <br />
            <FormControl>
              <Checkbox {...field} checked={!!field.value} onCheckedChange={field.onChange} value={""} />
            </FormControl>
        ...
        <FormField
          ...
          name="mediaClose"
          render={({ field }) => (<FormItem>
              <FormLabel>Media Close</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="mediaHeight"
          render={({ field }) => (<FormItem>
              <FormLabel>Media Height</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="mediaWidth"
          render={({ field }) => (<FormItem>
              <FormLabel>Media Width</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="minQuestions"
          render={({ field }) => (<FormItem>
              <FormLabel>Min Questions</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="modAttempts"
          render={({ field }) => (<FormItem>
              <FormLabel>Mod Attempts</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (<FormItem>
              <FormLabel>Next Page Default</FormLabel>
                <FormControl>
            <Input {...field} />
          </FormControl>
        ...
        <FormField
          ...
          name="progressbar"
          render={({ field }) => (<FormItem>
              <FormLabel>Progressbar</FormLabel>
                <br />
            <FormControl>
              <Checkbox {...field} checked={!!field.value} onCheckedChange={field.onChange} value={""} />
            </FormControl>
        ...
        <FormField
          ...
          name="useMaxGrade"
          render={({ field }) => (<FormItem>
              <FormLabel>Use Max Grade</FormLabel>
                <br />
            <FormControl>
              <Checkbox {...field} checked={!!field.value} onCheckedChange={field.onChange} value={""} />
            </FormControl>
        ...
        {editing ? (
          <Button
            type="button"
            variant={"destructive"}
            onClick={() => deleteLesson({ id: lesson.id })}
          >
