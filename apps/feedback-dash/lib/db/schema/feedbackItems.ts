...
export const insertFeedbackItemParams = baseSchema.extend({
...
export type CompleteFeedbackItem = Awaited<ReturnType<typeof getFeedbackItems>>["feedbackItems"][number];
