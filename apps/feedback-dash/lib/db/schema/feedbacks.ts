...
import { boolean, integer, text, varchar, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertFeedbackSchema = createInsertSchema(feedbacks).omit(timestamps);
