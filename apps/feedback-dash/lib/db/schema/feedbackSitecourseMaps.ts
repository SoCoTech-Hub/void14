...
export const feedbackSitecourseMaps = pgTable('feedback_sitecourse_maps', {
  ...
  feedbackId: varchar("feedback_id", { length: 256 }).references(() => feedbacks.id, { onDelete: "cascade" }).notNull()
});
...
export const insertFeedbackSitecourseMapSchema = createInsertSchema(feedbackSitecourseMaps);
export const insertFeedbackSitecourseMapParams = baseSchema.extend({
...
export type NewFeedbackSitecourseMap = z.infer<typeof insertFeedbackSitecourseMapSchema>;
export type NewFeedbackSitecourseMapParams = z.infer<typeof insertFeedbackSitecourseMapParams>;
export type UpdateFeedbackSitecourseMapParams = z.infer<typeof updateFeedbackSitecourseMapParams>;
export type FeedbackSitecourseMapId = z.infer<typeof feedbackSitecourseMapIdSchema>["id"];
    
// this type infers the return from getFeedbackSitecourseMaps() - meaning it will include any joins
export type CompleteFeedbackSitecourseMap = Awaited<ReturnType<typeof getFeedbackSitecourseMaps>>["feedbackSitecourseMaps"][number];
