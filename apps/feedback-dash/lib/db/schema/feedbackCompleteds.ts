...
export const insertFeedbackCompletedSchema = createInsertSchema(feedbackCompleteds).omit(timestamps);
export const insertFeedbackCompletedParams = baseSchema.extend({
...
export const updateFeedbackCompletedParams = baseSchema.extend({
  anonymousResponse: z.coerce.boolean(),
  randomResponse: z.coerce.number()
}).omit({ 
  userId: true
...
export type NewFeedbackCompleted = z.infer<typeof insertFeedbackCompletedSchema>;
export type NewFeedbackCompletedParams = z.infer<typeof insertFeedbackCompletedParams>;
export type UpdateFeedbackCompletedParams = z.infer<typeof updateFeedbackCompletedParams>;
export type FeedbackCompletedId = z.infer<typeof feedbackCompletedIdSchema>["id"];
    
// this type infers the return from getFeedbackCompleteds() - meaning it will include any joins
export type CompleteFeedbackCompleted = Awaited<ReturnType<typeof getFeedbackCompleteds>>["feedbackCompleteds"][number];
