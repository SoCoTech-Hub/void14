...
import { boolean, varchar, integer, timestamp, pgTable } from "drizzle-orm/pg-core";
...
export const insertFeedbackCompletedtmpSchema = createInsertSchema(feedbackCompletedtmps).omit(timestamps);
export const insertFeedbackCompletedtmpParams = baseSchema.extend({
...
export const updateFeedbackCompletedtmpParams = baseSchema.extend({
  anonymousResponse: z.coerce.boolean(),
  randomResponse: z.coerce.number()
}).omit({ 
  userId: true
...
export type NewFeedbackCompletedtmp = z.infer<typeof insertFeedbackCompletedtmpSchema>;
export type NewFeedbackCompletedtmpParams = z.infer<typeof insertFeedbackCompletedtmpParams>;
export type UpdateFeedbackCompletedtmpParams = z.infer<typeof updateFeedbackCompletedtmpParams>;
export type FeedbackCompletedtmpId = z.infer<typeof feedbackCompletedtmpIdSchema>["id"];
    
// this type infers the return from getFeedbackCompletedtmps() - meaning it will include any joins
export type CompleteFeedbackCompletedtmp = Awaited<ReturnType<typeof getFeedbackCompletedtmps>>["feedbackCompletedtmps"][number];
