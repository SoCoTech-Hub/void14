...
export async function POST(req: Request) {
  try {
    const validatedData = insertFeedbackSitecourseMapParams.parse(await req.json());
    const { feedbackSitecourseMap } = await createFeedbackSitecourseMap(validatedData);
...
export async function PUT(req: Request) {
  try {
    ...
    const validatedData = updateFeedbackSitecourseMapParams.parse(await req.json());
    const validatedParams = feedbackSitecourseMapIdSchema.parse({ id });

    const { feedbackSitecourseMap } = await updateFeedbackSitecourseMap(validatedParams.id, validatedData);
...
export async function DELETE(req: Request) {
  try {
    ...
    const validatedParams = feedbackSitecourseMapIdSchema.parse({ id });
    const { feedbackSitecourseMap } = await deleteFeedbackSitecourseMap(validatedParams.id);
