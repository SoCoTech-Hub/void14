...
export const insertBursaryCategorySchema = createInsertSchema(bursaryCategories);
...
export type NewBursaryCategoryParams = z.infer<typeof insertBursaryCategoryParams>;
export type UpdateBursaryCategoryParams = z.infer<typeof updateBursaryCategoryParams>;
...
export type CompleteBursaryCategory = Awaited<ReturnType<typeof getBursaryCategories>>["bursaryCategories"][number];
