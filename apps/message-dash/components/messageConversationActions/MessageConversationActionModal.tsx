...
import { MessageConversationAction } from "@/lib/db/schema/messageConversationActions";
    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Message Conversation Action</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <MessageConversationActionForm closeModal={closeModal} messageConversationAction={messageConversationAction} />
        </div>
      </DialogContent>
    </Dialog>
  );
