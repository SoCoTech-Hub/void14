...
export const insertMessageinboundDatakeySchema = createInsertSchema(messageinboundDatakeys).omit(timestamps);
export const insertMessageinboundDatakeyParams = baseSchema.extend({
...
export type NewMessageinboundDatakey = z.infer<typeof insertMessageinboundDatakeySchema>;
export type NewMessageinboundDatakeyParams = z.infer<typeof insertMessageinboundDatakeyParams>;
export type UpdateMessageinboundDatakeyParams = z.infer<typeof updateMessageinboundDatakeyParams>;
export type MessageinboundDatakeyId = z.infer<typeof messageinboundDatakeyIdSchema>["id"];
    
// this type infers the return from getMessageinboundDatakeys() - meaning it will include any joins
export type CompleteMessageinboundDatakey = Awaited<ReturnType<typeof getMessageinboundDatakeys>>["messageinboundDatakeys"][number];
