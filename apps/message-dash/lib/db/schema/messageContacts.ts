...
export const insertMessageContactSchema = createInsertSchema(messageContacts).omit(timestamps);
...
export type NewMessageContactParams = z.infer<typeof insertMessageContactParams>;
export type UpdateMessageContactParams = z.infer<typeof updateMessageContactParams>;
...
export type CompleteMessageContact = Awaited<ReturnType<typeof getMessageContacts>>["messageContacts"][number];
