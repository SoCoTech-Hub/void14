...
export const insertMessageConversationSchema = createInsertSchema(messageConversations).omit(timestamps);
export const insertMessageConversationParams = baseSchema.extend({
...
export type NewMessageConversation = z.infer<typeof insertMessageConversationSchema>;
export type NewMessageConversationParams = z.infer<typeof insertMessageConversationParams>;
export type UpdateMessageConversationParams = z.infer<typeof updateMessageConversationParams>;
export type MessageConversationId = z.infer<typeof messageConversationIdSchema>["id"];
    
// this type infers the return from getMessageConversations() - meaning it will include any joins
export type CompleteMessageConversation = Awaited<ReturnType<typeof getMessageConversations>>["messageConversations"][number];
