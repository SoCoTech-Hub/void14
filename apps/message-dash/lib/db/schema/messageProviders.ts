...
export type NewMessageProviderParams = z.infer<typeof insertMessageProviderParams>;
export type UpdateMessageProviderParams = z.infer<typeof updateMessageProviderParams>;
...
export type CompleteMessageProvider = Awaited<ReturnType<typeof getMessageProviders>>["messageProviders"][number];
