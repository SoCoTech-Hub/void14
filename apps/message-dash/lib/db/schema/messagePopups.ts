...
export const insertMessagePopupParams = baseSchema.extend({
...
export type CompleteMessagePopup = Awaited<ReturnType<typeof getMessagePopups>>["messagePopups"][number];
