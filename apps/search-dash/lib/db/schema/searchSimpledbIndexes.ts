...
export const insertSearchSimpledbIndexSchema = createInsertSchema(searchSimpledbIndexes).omit(timestamps);
export const insertSearchSimpledbIndexParams = baseSchema.extend({
...
export const updateSearchSimpledbIndexParams = baseSchema.extend({
  type: z.coerce.boolean()
}).omit({ 
  userId: true
});
...
export type NewSearchSimpledbIndex = z.infer<typeof insertSearchSimpledbIndexSchema>;
export type NewSearchSimpledbIndexParams = z.infer<typeof insertSearchSimpledbIndexParams>;
export type UpdateSearchSimpledbIndexParams = z.infer<typeof updateSearchSimpledbIndexParams>;
export type SearchSimpledbIndexId = z.infer<typeof searchSimpledbIndexIdSchema>["id"];
    
// this type infers the return from getSearchSimpledbIndexes() - meaning it will include any joins
export type CompleteSearchSimpledbIndex = Awaited<ReturnType<typeof getSearchSimpledbIndexes>>["searchSimpledbIndexes"][number];
