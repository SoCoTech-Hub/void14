...
export const insertSearchIndexRequestSchema = createInsertSchema(searchIndexRequests).omit(timestamps);
export const insertSearchIndexRequestParams = baseSchema.extend({
...
export type NewSearchIndexRequest = z.infer<typeof insertSearchIndexRequestSchema>;
export type NewSearchIndexRequestParams = z.infer<typeof insertSearchIndexRequestParams>;
export type UpdateSearchIndexRequestParams = z.infer<typeof updateSearchIndexRequestParams>;
export type SearchIndexRequestId = z.infer<typeof searchIndexRequestIdSchema>["id"];
    
// this type infers the return from getSearchIndexRequests() - meaning it will include any joins
export type CompleteSearchIndexRequest = Awaited<ReturnType<typeof getSearchIndexRequests>>["searchIndexRequests"][number];
