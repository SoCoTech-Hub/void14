    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Search Index Request</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <SearchIndexRequestForm closeModal={closeModal} searchIndexRequest={searchIndexRequest} />
        </div>
      </DialogContent>
    </Dialog>
  );
