...
import { type getBackupCourses } from "@/lib/api/backupCourses/queries";
...
export const insertBackupCourseSchema = createInsertSchema(backupCourses).omit(timestamps);
export const insertBackupCourseParams = baseSchema.extend({
...
export type CompleteBackupCourse = Awaited<ReturnType<typeof getBackupCourses>>["backupCourses"][number];
