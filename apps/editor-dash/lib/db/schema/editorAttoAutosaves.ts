...
export const insertEditorAttoAutosaveSchema = createInsertSchema(editorAttoAutosaves).omit(timestamps);
...
export type NewEditorAttoAutosave = z.infer<typeof insertEditorAttoAutosaveSchema>;
export type NewEditorAttoAutosaveParams = z.infer<typeof insertEditorAttoAutosaveParams>;
export type UpdateEditorAttoAutosaveParams = z.infer<typeof updateEditorAttoAutosaveParams>;
export type EditorAttoAutosaveId = z.infer<typeof editorAttoAutosaveIdSchema>["id"];
    
// this type infers the return from getEditorAttoAutosaves() - meaning it will include any joins
export type CompleteEditorAttoAutosave = Awaited<ReturnType<typeof getEditorAttoAutosaves>>["editorAttoAutosaves"][number];
