import { getScaleHistoryById, getScaleHistories } from "@/lib/api/scaleHistories/queries";
...
import { createScaleHistory, deleteScaleHistory, updateScaleHistory } from "@/lib/api/scaleHistories/mutations";
