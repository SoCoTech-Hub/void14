import { text, integer, real, varchar, pgTable, uniqueIndex } from 'drizzle-orm/pg-core'
...
export const quizFeedbacks = pgTable(
	...
	(quizFeedbacks) => {
		return {
			quizIdIndex: uniqueIndex('quiz_feedbacks_quiz_id_idx').on(
				quizFeedbacks.quizId
			)
		}
	}
)
