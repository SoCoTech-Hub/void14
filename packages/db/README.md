...
- **private**: `BIT(1)`, Indicates whether the page is private (`1`, Database) or public (`0`, profile).
...
This README provides an overview of the tables in the User Database application, along with their fields and functions.
